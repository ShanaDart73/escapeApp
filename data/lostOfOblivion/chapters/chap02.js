        ...
        <Wrapper>
            <Container onContextMenu={(e) => e.preventDefault()}>
                ...
                <Content>
                    ...
                    <p>The embankment of Shiyan was built where the width of Han River was the most narrow, and also it was mostly likely to be burst by the floods.</p>
                    <p>Since Jiāng Chéng was personally supervising the operation there, therefore, the situation of the lower reaches must be critical.</p>
                    <p>During all this time, eyes filled with tears, Yú XiǎoShān was inwardly blaming himself so much that he was unable to express himself.</p>
                    <p>Wèi WúXiàn, who was briefly informed of what happened in the pond, patted him on the shoulder, and said, “In the recent years, there has been many floods occurring in Yúnmèng. Now, it’s clear that they were caused by the young dragon.</p>
                    ...
                    <p>Yú XiǎoShān was still young after all, and could no longer hold back his tears. He started to cry.</p>
                    <p>He then felt embarrassed, and wiped away his tears. He called while choking back his tears, “Wèi qiánbèi...”</p>
                    ...
                    <p>“In the last years of the previous dynasty, the lower reaches areas of Han River were occupied by the army of the current dynasty.</p>
                    <p>“In order to crush the enemy downstream, the emperor of the previous dynasty personally order to construct a dam, so that when the flood happened, water would be stored in that reservoir, and, later on, to be released to inundate the downstream areas.</p>
                    ...
                    <p>“Ankang City is nearby, and the width of its river is much narrow. So, the Ankang embankment burst under pressure, and the city was flooded.</p>
                    <p>“The flood had caused a lot of casualties in the lower reaches areas of Ankang River, causing common people to harbour a grievance against the emperor.</p>
                    ...
                    <p>“As you can see, this area is fertile, and the grain yield is high. So, more and more people have come here to settle. And, up to the present time, there are about a hundred households living in that village.</p>
                    <p>“If the dam is blown up, the village will be submerged.</p>
                    <p>“In fact, people are not supposed to live in that location. Although imperial officials came multiple times to persuade them to move out, the villagers are reluctant to leave the land they are attached to.</p>
                    <p>“The leader also came to see them, but they still haven’t changed their mind.</p>
                    ...
                    <p>“If you have the YúnmèngJiāng sect decree with you, go and ask the imperial officials to come to the village. We’ll wait for you there.”</p>
                    <p>Then he talked to Lán WàngJī, “Lán Zhàn, let’s go ahead.”</p>
                    <p>“Okay.” agreed Lán WàngJī, then he set Bìchén in motion and flew towards the village, along with the rest of YúnmèngJiāng sect disciples.</p>
                    <br />
                    <p>... ... ...</p>
                    <br />
                    ...
                    <p>The drillmaster in charge of the relocation process stepped in, “Every year, in spring, the prefect issues a relocation order for you to move out.</p>
                    ...
                    <p>After a short pause, the drillmaster resumed, “The compensation has already been assessed. Right now, you are taking the advantage of this emergency to increase the amount of the compensation.”</p>
                    <p>Persuading those people to move out from their village had always been a hassle. Upon seeing the YúnmèngJiāng sect decree, the authorities had mobilised nearly a hundred officials to assist in relocating the villagers.</p>
                    <p>Lán WàngJī said, “As I have already stated, I promise you that GūsūLán will pay for your looses, if the authorities fail to compensate you in time.”</p>
                    ...
                    <p>They all had shuddered with horror listening to the vicious methods of Yílíng Lǎozǔ.</p>
                    <p>Wèi WúXiàn slowly turned his flute to let everyone see the scarlet tassel, which was Yílíng Lǎozǔ’s signature.</p>
                    <p>He then smiled, and said, “I am Yílíng Lǎozǔ, also known as Wèi WúXiàn.”</p>
                    <p>As he finished talking, Wèi WúXiàn brought Chénqíng to his lower lip, and, at leisure, he blew a few notes.</p>
