...
const Sound = () => {
	...
	const soundList = [
		...
		{ name: <MyAudio sound="/audio/lanyan.mp3" name="Lán Yǎn" />, id: 20 },
		{ name: <MyAudio sound="/audio/lanzhan.mp3" name="Lán Zhàn" />, id: 21 },
		{ name: <MyAudio sound="/audio/liebing.mp3" name="Lièbīng" />, id: 21 },
		{ name: <MyAudio sound="/audio/qiankundai.mp3" name="qiánkūn-dài" />, id: 22 },
		{ name: <MyAudio sound="/audio/qinghengjun.mp3" name="Qīnghéng-Jūn" />, id: 22 },
		{ name: <MyAudio sound="/audio/qingxinling.mp3" name="Qīngxīn-líng" />, id: 23 },
		{ name: <MyAudio sound="/audio/sanduyu.mp3" name="Sāndúyù" />, id: 23 },
		{ name: <MyAudio sound="/audio/shifu.mp3" name="shīfu" />, id: 23 },
		{ name: <MyAudio sound="/audio/shijie.mp3" name="Shījiě" />, id: 24 },
		{ name: <MyAudio sound="/audio/shuoyue.mp3" name="Shuòyuè" />, id: 24 },
		{ name: <MyAudio sound="/audio/sizhui.mp3" name="SīZhuī" />, id: 25 },
		{ name: <MyAudio sound="/audio/suihua.mp3" name="Suìhuá" />, id: 26 },
		{ name: <MyAudio sound="/audio/weiqianbei.mp3" name="Wèi-qiánbèi" />, id: 27 },
		{ name: <MyAudio sound="/audio/weiwuxian.mp3" name="Wèi WúXiàn" />, id: 28 },
		{ name: <MyAudio sound="/audio/weiying.mp3" name="Wèi Yīng" />, id: 29 },
		{ name: <MyAudio sound="/audio/wenning.mp3" name="Wēn Níng" />, id: 30 },
		{ name: <MyAudio sound="/audio/wenqing.mp3" name="Wēn Qíng" />, id: 31 },
		{ name: <MyAudio sound="/audio/xiongzhang.mp3" name="Xiōng-zhǎng" />, id: 32 },
		{ name: <MyAudio sound="/audio/yunmengjiang.mp3" name="YúnmèngJiāng" />, id: 33 },
		{ name: <MyAudio sound="/audio/yunshenbuzhichu.mp3" name="Yúnshēn Bùzhīchù" />, id: 34 },
		{ name: <MyAudio sound="/audio/zewujun.mp3" name="Zéwú-Jūn" />, id: 35 },
		{ name: <MyAudio sound="/audio/zongzhu.mp3" name="Zōng-zhǔ" />, id: 36 },
	]
