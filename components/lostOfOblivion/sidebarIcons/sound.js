...
const Sound = () => {
    ...
    const soundChapList = [
        ...
        { name: <MyAudio sound="/audio/moxuanyu.mp3" name="Mò XuánYǔ" />, id: 24 },
        { name: <MyAudio sound="/audio/niehuaisang.mp3" name="Niè HuáiSāng" />, id: 25 },
        { name: <MyAudio sound="/audio/qinghenie.mp3" name="QīnghéNiè" />, id: 26 },
        { name: <MyAudio sound="/audio/sizhui.mp3" name="SīZhuī" />, id: 27 },
        { name: <MyAudio sound="/audio/suibian.mp3" name="Suíbiàn" />, id: 28 },
        { name: <MyAudio sound="/audio/suihua.mp3" name="Suìhuá" />, id: 29 },
        { name: <MyAudio sound="/audio/wangxian.mp3" name="WàngXiàn" />, id: 30 },
        { name: <MyAudio sound="/audio/weiqianbei.mp3" name="Wèi qiánbèi" />, id: 31 },
        { name: <MyAudio sound="/audio/weishan.mp3" name="Wěishàn" />, id: 32 },
        { name: <MyAudio sound="/audio/weiwuxian.mp3" name="Wèi WúXiàn" />, id: 33 },
        { name: <MyAudio sound="/audio/weixiong.mp3" name="Wèi-xiōng" />, id: 34 },
        { name: <MyAudio sound="/audio/weiying.mp3" name="Wèi Yīng" />, id: 35 },
        { name: <MyAudio sound="/audio/xiongzhang.mp3" name="Xiōng-zhǎng" />, id: 36 },
        { name: <MyAudio sound="/audio/yilinglaozu.mp3" name="Yílíng Lǎozǔ" />, id: 37 },
        { name: <MyAudio sound="/audio/yunmengjiang.mp3" name="YúnmèngJiāng" />, id: 38 },
        { name: <MyAudio sound="/audio/yunshenbuzhichu.mp3" name="Yúnshēn Bùzhīchù" />, id: 39 },
        { name: <MyAudio sound="/audio/yuxiaoshan.mp3" name="Yú XiǎoShān" />, id: 40},
        { name: <MyAudio sound="/audio/zewujun.mp3" name="Zéwú-Jūn" />, id: 41 },
        { name: <MyAudio sound="/audio/zhang.mp3" name="Zhāng" />, id: 42 }
    ]
