    ...
    return (
        <>
            <Link href="/lostOfOblivion/chapters/1">
                <div className="block w-canvas-width h-canvas-height p-4 bg-gray-950 brightness-100 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                    <div className="text-gray-500 flex flex-col items-center">
                        ...
                        <h2 className="italic font-canvas-font-title text-2xl">Lost Of Oblivion</h2>
                    </div>
            ...
            <div className="block w-canvas-width h-canvas-height p-4 bg-gray-950 brightness-100 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                <div className="text-gray-500 flex flex-col items-center">
                    ...
                    <h2 className="italic font-canvas-font-title text-2xl">Lan Wangji versus Alcohol</h2>
                </div>
                <div className="text-gray-500 font-canvas-font-title md:text-canvas-md-size">
                    <h2 className="italic font-canvas-font-title text-2xl text-center">Coming soon</h2>
                </div>
            </div>
            <div className="block w-canvas-width h-canvas-height p-4 bg-gray-950 brightness-100 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                <div className="text-gray-500 flex flex-col items-center">
