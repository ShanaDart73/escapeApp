    ...
    return (
        <>
            <Link href="/lostOfOblivion/chapters/1">
                <div className="block w-canvas-width h-canvas-height p-4 bg-gray-950 brightness-50 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                    ...
                    <div className="text-gray-400 font-canvas-font-title md:text-canvas-md-size">
