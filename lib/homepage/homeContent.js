    ...
    return (
        <>
            <Link href="/lostOfOblivion/chapters/1">
                <div className="text-gray-400 block w-canvas-width h-canvas-height p-4 bg-gray-950 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                    <div className="flex flex-col items-center">
                        <img style={{ borderRadius: "2px 50%" }} className="brightness-75" src="/photos/homepage/lostOfOblivion.png" alt="WangXian" />
            ...
            <Link href="/lanWangjiVsAlcohol/chapters/1" >
                <div className="text-gray-400 block w-canvas-width h-canvas-height p-4 bg-gray-950 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                    <div className="flex flex-col items-center">
                        <img style={{ borderRadius: "2px 50%" }} className="brightness-75" src="/photos/homepage/lanwangjiVsAlcohol.jpg" alt="WangXian" />
            ...
            <div
                ...
                <div className="flex flex-col items-center">
                    <img style={{ borderRadius: "2px 50%" }} className="brightness-75" src="/photos/homepage/dreaming.jpg" alt="WangXian" />
