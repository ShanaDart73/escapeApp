    ...
    return (
        <>
            <Link href="/lostOfOblivion/chapters/1">
                <div className="text-gray-400 block w-canvas-width h-canvas-height p-4 bg-gray-950 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                    <div className="flex flex-col items-center">
                        <img className="rounded-tr-canvas-radius rounded-bl-canvas-radius brightness-75" src="/photos/homepage/lostOfOblivion.png" alt="WangXian" />
                        <h2 className="italic font-canvas-font-title text-2xl text-center">Lost Of Oblivion</h2>
                    </div>
                    <div className="font-canvas-font-title md:text-canvas-md-size">
            ...
            <Link href="/lanWangjiVsAlcohol/chapters/1" >
                <div className="text-gray-400 block w-canvas-width h-canvas-height p-4 bg-gray-950 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                    <div className="flex flex-col items-center">
                        <img className="rounded-tr-canvas-radius rounded-bl-canvas-radius brightness-75" src="/photos/homepage/lanwangjiVsAlcohol.jpg" alt="WangXian" />
            ...
            <div
                className="text-gray-400 block w-canvas-width h-canvas-height p-4 bg-gray-950 shadow-homePic-shadow rounded-lg hover:-translate-y-1 hover:shadow-homePic-hover">
                <div className="flex flex-col items-center">
                    <img className="rounded-tr-canvas-radius rounded-bl-canvas-radius brightness-75" src="/photos/homepage/dreaming.jpg" alt="WangXian" />
