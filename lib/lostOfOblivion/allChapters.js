...
export const ChapOne =
    <div>
        <section>
            ...
            <p>For those who are keen to hear the correct pronunciation of the characters and places' names, when the name is highlighted like this <span>Wèi WúXiàn</span>, please tap/hover over the audio icon on the top left of the screen; the names are sorted by the order of their appearance in the chapter.</p>
            <br />
        </section>
        <p>“<span>Wèi qiánbèi</span>*...” cried <span>Yú XiǎoShān</span>, overwhelming with remorse.</p>
        ...
        <p>However, right now, <span>Wèi WúXiàn</span> spotted a pitch dark pond that they had overlooked. On close inspection, it was hard to determine the depth of the pond.</p>
        ...
        <p>Wèi WúXiàn smiled, and said, “<span>Lán Zhàn</span>, this promises to be interesting.”</p>
        <p>All teenagers understood that there was a need to investigate the pond. So, full of energy, the disciples of the <span>YúnmèngJiāng</span> sect* were already gearing up to dive in. Each of them wanted to show their swimming skills to the teenagers of the <span>GūsūLán</span> clan*.</p>
        ...
        <p>Yú XiǎoShān was the eldest grandson of the <span>MéishānYú</span> clan. Since he was a child, he had an outstanding spiritual power and extraordinary talent. Furthermore, he was highly praised when he was studying at Lotus Pier*.</p>
        ...
        <p><span>Lán WàngJī</span> said, “<span>Wèi Yīng</span>*, I will dive with them because the water is too cold. However, Lán Yù and Lán Héng are not good at swimming. So, they will stay with you here, on the bank.”</p>
        ...
        <p><span>Lán Qí</span>, a teenager from GūsūLán clan, who had just stepped on his sword, but hadn’t the time to steady himself, was caught in the vortex.</p>
        ...
        <p>To fly as fast as he could, Wèi WúXiàn used all his spiritual power. Now, he felt exhausted. Furthermore, since there was no more spiritual power left to feed his sword, Wèi WúXiàn could no longer make <span>Suíbiàn</span>* move.</p>
        ...
        <p>At the moment they saw Lán WàngJī turning his head towards them, some YúnmèngJiāng sect’s disciples hurriedly turned around to avoid eye contact. Lán <span>SīZhuī</span> blindfolded Lán <span>JǐngYí</span> with his hands, while closing his own eyes tight.</p>
...
export const ChapTwo =
    <div>
            ...
            <small>*Second Brother (二哥哥, èr gēgē) is referred to the second child of a family.</small>
