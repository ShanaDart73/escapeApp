...
export const ChapOne =
    <div>
        ...
        <p>He thought, “This is not the first time I am facing death.”</p>
        <p>“Wèi Yīng!”</p>
...
export const ChapTwo =
    <div>
        ...
        <p>“Uh,” agreed Lán WàngJī. He then looked far into the distance, observing the endless dark clouds that covered the whole city, the torrential rain that poured like hell, and the strong wind that roared like a tiger.</p>
...
export const ChapFour =
    <div>
        ...
        <p>“It’s done,” he sighed. Then, all of a sudden, he got dizzy, and, with the extreme pain in his abdomen, he was no longer able to stand on his sword, and fell on his butt along with his sword on the riverbed presently exhibited.</p>
...
export const ChapFive =
    <div>
        ...
        <p>“Indeed, time has passed and things have changed. At that time, he called me ‘Leader Niè’ instead of ‘HuáiSāng-xiōng’*,” thought Niè HuáiSāng.</p>
        ...
        <p>Niè HuáiSāng sighed, then thought, “HánGuāng-Jūn blew up an extremely stout dam by himself, then, for two days, he hasn’t rested but kept on playing his guqin in order to find Wèi WúXiàn.</p>
...
export const ChapSix =
    <div>
        ...
        <p>Lán WàngJī, to whom the loss of Wèi WúXiàn’s memories came as a great blow, slowly began to loose his fist that he had clenched in shock. “At least, he still remember me,” he thought.</p>
        ...
        <p>Wèi WúXiàn finally calmed himself down, and appeared to be relieved. He thought, “Since Lán Zhàn said that Jīn Líng is fine, then it must be true.” The noises inside his head began gradually to vanish.</p>
        ...
        <p>With his head tilted to one side, Wèi WúXiàn asked, “Lán Zhàn, are you going as well?”</p>
        ...
        <p>“So, what you mean is,” Wèi WúXiàn remarked while eating the bowl of congee that Lán WàngJī served him, “I woke up from a coma, and have lost twenty years of memories.”</p>
        ...
        <p>Unsure, Jīn Líng asked, “Do you really accept that I am Jīn Líng?”</p>
        <p>Wèi WúXiàn replied, “Of course, I do. Why should I not accept it since HánGuāng-Jūn already said that it’s true?”</p>
        <p>“Hmm! The congee was really delicious,” Wèi WúXiàn remarked. Then he went on, “Lán Zhàn, GūsūLán has improved the taste of its cooking.”</p>
...
export const ChapSeven =
    <div>
        ...
        <p>“A few years ago, father was tired of whole clan’s affairs,” Jīn Líng went on, “He wanted to spend more time with mother, so he designated me to become the leader our clan, then, along with mother, they have set off on journey, sightseeing the eastern regions.”</p>
        ...
        <p>Then, suddenly something crossed his mind, he said, “Eh! Lán Zhàn, you haven't said 'Don't speak while eating' yet!”</p>
        ...
        <p>Then, he hesitantly asked, “Will..., will he be able to recover his memories?”</p>
        ...
        <p>“In that case, I’ll give her a nickname,” said Wèi WúXiàn, “After all, I was the one who saved her. Everyone can call her by her nickname.”</p>
        <p>“All right,” said Lán WàngJī.</p>
        <p>“Since she has a round and reddish face, I’ll name her Little Apple*,” said Wèi WúXiàn.</p>
        ...
        <p>He then went on, “I was washed away by the flood. Was it you who found me?”</p>
        ...
        <p>“The issue of the last Wēn clan has already been solved,” thoughy Wèi WúXiàn, “So, that probably means that Jiāng Chéng and I have been reconciled with each other.”</p>
...
export const ChapEight =
    <div>
        ...
        <p>Wèi WúXiàn bowed, and thought, “Just now, Zéwú-Jūn called me ‘WúXiàn’ instead of ‘Wèi-gōngzǐ’*. Do we already have such a close familiarity?”</p>
        ...
        <p>With a bright smile on his face, Wèi WúXiàn wondered, “What is he worried about? Oh! I’ve got it!” </p>
        ...
        <p>Noticing that Jiāng Chéng’s expression had suddenly changed, Wèi WúXiàn had second thoughts. He thought, “For things I still want to know, I think I’d better ask Lán Zhàn, later on, rather than asking Jiāng Chéng.”</p>
...
export const ChapNine =
    <div>
        ...
        <p>Then he thought, “Indeed, everything that was said is true, but the most important thing is left out. His account doesn’t contain all the facts.”</p>
        <p>Wèi WúXiàn was stunned by those revelations, he went on thinking, “I have been with Lán Zhàn continuously, like two people living together. Moreover, people are still seeing me like a devil, and, in order to protect me, Lán Zhàn compromises himself.”</p>
        ...
        <p>He thought, “How on earth Wèi WúXiàn managed to see any sadness on Lán WàngJī’s face? Furthermore, I don’t see him looking dreadful at all.”</p>
...
export const ChapTen =
    <div>
        ...
        <p>Kneeling in front Wèi WúXiàn,  Lán WàngJī replied while rolling up Wèi WúXiàn’s trouser leg, “That guqin is not mine. It’s yours.”</p>
        ...
        <p>“Currently, there is a place where we can go and have a lunch over there,” replied Lán WàngJī, "Then, in afternoon, we can take a boat and sightsee the surrounding areas.”</p>
...
export const Chap11 =
    <div>
        ...
        <p>Wèi WúXiàn hurriedly replied, “I’m feeling fine.” Then, he put a hand on his face and thought, “Indeed, my face is burning hot.”</p>
        ...
        <p>However, he simply replied, “I slept well.”Tthen he realised, “It’s strange that I easily fell asleep. Didn’t you say that I was in a coma for few days?”</p>
        <p>“You usually don’t wake up so early in the morning,” he replied.</p>
        <p>“Let’s go to the town,” Lán WàngJī went on, “What do you want to eat?”</p>
        <p>“We’ve already arrived. What is this place?” he asked.</p>
        <p>“This is Cross-Path Village,” Lán WàngJī replied.</p>
...
export const Chap12 =
    <div>
        ...
        <p>“Let me have a look at the seasonal vegetables,” he went on, “Add one dish of stir-fried garland chrysanthemum with peas. And, finally, one dish of chicken with bean curd, and two dipping sauces, one spicy and the other non-spicy.”</p>
        ...
        <p>“Not at all,” Wèi WúXiàn replied, “Otherwise, we will have to wait in such a long queue. Let’s go somewhere else instead. Didn’t you plan for us to sightsee on a boat?”</p>
        ...
        <p>Wèi WúXiàn clenched his fists, while thinking, “I thought that my heart was as hard as a rock, that nothing will shake me up. I was wrong.”</p>
        ...
        <p>“If the rumour was only about me,” thought Wèi WúXiàn, “I would not care in the slightest. However, I can’t tolerate the fact that Lán Zhàn has been bad-mouthed, as well.”</p>
        ...
        <p>With a derisive smile, he went on, “It’s just that other people don’t think that way.”</p>
        ...
        <p>He went on, “A warrior is always by himself, walking his path alone. Luckily, the character in the story has someone, who never leaves his side.</p>
...
export const Chap13 =
    <div>
        ...
        <p>“Like the characters in the story,” he went on, “I feel that I was completely defeated, a perfect failure covered with blood, rebuked and criticised by others, being extremely desperate and having no other choice but to cry.</p>
        ...
        <p>“He said it hadn’t hurt at all,” thought Lán WàngJī, “In fact, it had hurt so much. Even after all these years, he still doesn’t want to talk about it openly.”</p>
        ...
        <p>“This is really going to kill me,” thought Wèi WúXiàn.</p>
...
export const Chap14 =
    <div>
        ...
        <p>“Shall I touch his hand?” wondered Wèi WúXiàn, “If Lán Zhàn avoids my touching him, I will just feign ignorance.” After a pause, he went on thinking, “Somehow, I feel that Lán Zhàn won’t dodge my touch.”</p>
        <p>“Throughout the entire day, Lán Zhàn himself has been touching me,” he thought, “Hold on! It sounds a little bit weird to use the word ‘touching’ when it comes to Lán Zhàn.”</p>
        ...
        <p>He went on, “That could be plausible, because Lán Zhàn is kind, as well as handsome, so it is hard not to like him.”</p>
        <p>He turned his head so to look at Lán WàngJī. “Indeed, Lán Zhàn is very handsome,” he thought, “his eyebrows, his eyes, his nose and his lips are really beautiful. He is without a doubt the most good-looking man I’ve ever seen.”</p>
        ...
        <p>Then, “Good heavens! What did I just say?” he thought, “That was careless of me to say those words. And, what Lán Zhàn is going to think of it?”</p>
        ...
        <p>“Do you want me to bathe before you?” Lán WàngJī asked.</p>
        ...
        <p>“If my guess is correct,” he thought, “that would mean that Lán Zhàn and I are intimately close.</p>
        ...
        <p>He went on, “I should think it over, once more, shouldn’t I? No. I should calm myself down, I need to calm down, I have to pull myself together.”</p>
...
export const Chap15 =
    <div>
        ...
        <p>At the sight of these inviting lips, Lán WàngJī unconsciously clenched his free hand into a fist, he said, “All right.” Then he walked to the table to put back the cup.</p>
        ...
        <p>“What do you think?” Lán WàngJī asked. Then he sighed and went on, “Wèi Yīng, what kind of relationship do you wish us to have?”</p>
...
export const Chap16 =
    <div>
        ...
        <p>“If it carries on like this,” Wèi WúXiàn thought, “I will soon come inside Lán Zhàn’s mouth. I can’t do that to Lán Zhàn. I must not!”</p>
        ...
        <p>“Aaah! Lán Zhàn!” Wèi WúXiàn moaned loudly, and he almost jumped off the bed, then he thought, “Why is there something like that inside a man’s body?”</p>
        ...
        <p>With a smile on his face, Lán WàngJī replied, “Yes, I will show you.” Then, he pressed on the sensitive P-spot, which caused Wèi WúXiàn to reach another climax.</p>
...
export const Chap18 =
    <div>
        ...
        <p>“Wèi Yīng, you are not allow to get out of bed,” said Lán WàngJī.</p>
        ...
        <p>“Um, it feels a little bit cold,” he replied, then asked, “Lán Zhàn, can I do it myself?”</p>
        <p>“No, you can’t.”</p>
        ...
        <p>“No, I can’t,” he replied, and also noticed that Wèi WúXiàn was getting hard.</p>
        <p>“At least, don’t raise my bottom so high.” Wèi WúXiàn was really embarrassed.</p>
        <p>“That won’t do.” He stopped moving his fingers inside Wèi WúXiàn and went on, “This position allows me to see inside more clearly.”</p>
        ...
        <p>“Wèi Yīng, the meaning of wearing GūsūLán’s forehead ribbon is to restrain oneself,” said Lán WàngJī in his deep voice that resounded inside Wèi WúXiàn’s ears.</p>
        <p>He went on, “Only in the presence of a soulmate, the person you love, that there is no need to restrain yourself.”</p>
...
export const Chap19 =
    <div>
        ...
        <p>However, Wèi WúXiàn was not as cautious as Lán WàngJī was, he said, “Èr-gēge*, I trust you. So, you can go deeper and enter the realm of my unconscious mind. In that way, you’ll be able to accelerate the whole process.”</p>
        <small>*Since ‘Second Brother’ sounds weird in English language, from now on Èr-gēge will be used instead. The correct pronunciation of Èr-gēge is on the sidebar.</small>
        <p>Seeing that Lán WàngJī was not happy about his suggestion, Wèi WúXiàn did not insist.</p>
        <p>He then put his arms around Lán WàngJī’s neck, and, in a coquettish way, he said, “Èr-gēge, don’t worry. It’s fine if you don’t want to do it. Just help me open up the main paths of my spiritual veins, I’ll do the rest. I promise that I’ll work hard to strengthen my foundation.”</p>
...
export const Chap21 =
    <div>
        ...
        <p>He went on, “Why Lán Zhàn is so awesome? Not only he is very good-looking, but also...” Wèi WúXiàn felt shy* to finish his sentence, he then added, “Lán Zhàn is really good at everything.”</p>
        ...
        <p>Wèi WúXiàn went on, “He also said, ‘Wèi Yīng, in BǎiFèngShān, it was me who kissed you.’. It was really an amazing surprise to learn that Lán Zhàn has started to like me since back then.”</p>
        ...
        <p>He bent down and said, “Wèi Yīng, you're awake? Do you want to eat——”</p>
        ...
        <p>He went on “Since you had not mentioned it earlier, I thought that you had not sensed the golden core at all. So, I was worried that something was wrong with the golden core.”</p>
        ...
        <p>Lán WàngJī thought, “I know how a golden core means to Wèi Yīng. However, he chose to give up on it with the risk of no longer be able to form another one..</p>
        ...
        <p>“I really want to be inside him, right now,” Lán WàngJī thought, while looking at Wèi WúXiàn intensively, “All day of yesterday, I had longed to hold him, feel his naked body against mine.</p>
        ...
        <p>“Lán Zhàn is like an overlord right now, making me feel powerless and submissive,” thought Wèi WúXiàn.</p>
...
export const Chap22 =
    <div>
        ...
        <p>He went on, “So, if I followed correctly, you used your semen as a medium and passed through the spiritual veins barrier, then penetrated into my unconscious mind, and helped me restore my golden core.”</p>
        ...
        <p>He went on, “Since there are many memories residing in the realm of the conscious mind, having another conscious mind penetrating inside might destabilise the conscious mind of the host.</p>
        ...
        <p>He went on, this time, with a smile, “I think it was a good fortune that you had insisted on penetrating only the realm of my conscious mind, and help me open up the main points of my spiritual veins. Doing so, you have gradually let me get used to your spiritual power.</p>
...
export const Chap23 =
    <div>
        ...
        <p>“First, purify its soul. Second, suppress it, if the first method fails. And, finally, if the second method also fails, annihilate it.” Then he went on, “It’s what you replied. You’re always right.”</p>
        ...
        <p>He went on, “Lán Zhàn, you have already helped me restore my golden core. From now on, I’ll be using mostly my spiritual power, and less of my demonic power.”</p>
        ...
        <p>“Argh.” With a voice that sounded like a moan, Wèi WúXiàn said, “Are we not going to bed?”</p>
        <p>“No. There's no need,” replied Lán WàngJī, then, he held Wèi WúXiàn by his waist, and, in a commanding tone, he said, “Wèi Yīng, raise you buttocks.”</p>
        ...
        <p>“Aaah... argh.” While moaning Wèi WúXiàn thought, “This is way too fast.”</p>
...
export const Chap24 =
    <div>
        ...
        <p>Becoming aware of being watched, Wèi WúXiàn felt a little bit shy. “Èr-gēge,” he called as he raised his head towards Lán WàngJī’s face, with an expression on his face that said ‘kiss me’.</p>
        ...
        <p>“Aargh... Èr-gēge, have you not become bigger?”</p>
        ...
        <p>“Haaah... Èr-gēge, I take back what I have said. You are too big.”</p>
        ...
        <p>“He is indeed mine,” thought Lán WàngJī, “Not only he has not forgotten about me, but also he can subconsciously remember the rules of GūsūLán.</p>
...
export const Chap25 =
    <div>
        ...
        <p>“Ah!” surprised, Wèi WúXiàn thought, “Did Lán Zhàn slap me or gave me a pat? It was so gentle that I’m not sure which one was.”</p>
        ...
        <p>Then he went on,  “How about you recite a few rules to help me remember them?”</p>
        ...
        <p>“Aaah... Èr-gēge, I can’t remember the rest of the rules. Please, have mercy on me. Argh... Don’t hit that place so hard.”</p>
        ...
        <p>Without warning, he thrust his hot stuff deeply inside Wèi WúXiàn’s hole. Then, he counted, “One.” and went on, “Count the rest by yourself.”</p>
        ...
        <p>“Lán Zhàn is going to punish me, again.” Wèi WúXiàn thought, “Whatever he wants me to do I will do it.”</p>
        ...
        <p>Wèi WúXiàn wanted to say, “Be gentle, Èr-gēge. You can do whatever you want, but, please, be gentle.” However, his mouth was sealed.</p>
...
export const Chap26 =
    <div>
        <br />
        <p>“Èr-gēge, my forehead ribbon got too soaked to be worn,” said Wèi WúXiàn.</p>
        ...
        <p>The first thing Wèi WúXiàn saw was a few clay jars of ‘Emperor's Smile’*</p>
        <small>*Emperor's Smile is the name of the wine made in Gūsū region, and Wèi WúXiàn’s favourite wine.</small>
        ...
        <p>Wèi WúXiàn opened the box, and took out a booklet that was titled ‘Mountain of Joy and Grief’. He glanced through it, and was dumbfounded. Then, he sighed and said, “Lán Zhàn has become really indecent.”</p>
...
export const Chap27 =
    <div>
        ...
        <p>He went on after a short pause, “This morning, you helped me again strengthen my golden core via the dual cultivation. I have now begun to feel the result.</p>
        ...
        <p>She went on, “Wèi-gōngzǐ, I heard that you have temporarily lost your memories. Have you also forgotten about us?”</p>
        ...
        <p>Overexcited, Wèi WúXiàn went on, “So, now there are two Mián-Mián: a grown-up and a little Mián-Mián.”</p>
        ...
        <p>“His name is YuǎnDào,” Lín Ruì replied, “Mián-Mián always wanted to have brothers and sisters to play with her.”</p>
        <p>He went on, “Speaking of the name, Wèi-gōngzǐ, this name can be considered to be chosen by you.”</p>
...
export const Chap28 =
    <div>
        ...
        <p>Luó QīngYáng smiled, and said, “Right now, you better stay in my belly, and be good.” Then she went on, “Every day, he is wiggling all day along. I will be busy after giving birth to him.”</p>
        ...
        <p>Having boastfully said that much about himself, Lán SīZhuī’s face turned slightly red in embarrassment, “I..., I have grown up well.”</p>
...
export const Chap29 =
    <div>
        ...
        <p>“Yes,” replied Lán WàngJī, then he went on, “He will wake up soon.”</p>
...
export const Chap30 =
    <div>
        ...
        <p>“You know what I mean,” replied Jīn Líng, then he went on, “Uncle, I think it’s good for both of you to be on friendly terms.”</p>
...
export const Chap31 =
    <div>
        ...
        <p>In a very low voice, Lán WàngJī agreed, “Uh.”</p>
        ...
        <p>He said, “Anyway, Èr-gēge, I want you to know that I’ve never had any feelings for Wēn Qíng. And, you should also know that she was not head over heels in love with me, either.”</p>
        <p>And, in a humorous tone, he went on, “Someone said that I am a genius, handsome and romantic. Of course, it’s hard for a girl, who sees me, not to turn around and look at me again... Aargh!”</p>
        ...
        <p>Then, Wèi WúXiàn, once more, put his forehead against Lán WàngJī’s chin, and asked, “Èr-gēge, are you feeling better now? You’re no longer jealous regarding Wēn Qíng?”</p>
...
export const Chap34 =
    <div>
        <br />
        <p>While tossing up some peanuts one by one, which landed into his mouth, and having a smile on in his face, Wèi WúXiàn said, “So, in other words, it was you who spread those nonsense rumours about me.”</p>
        <p></p>
        <p>Jīn Líng’s face turned red with embarrassment.</p>
        <p>This was the first time he earnestly admitted his mistake towards Wèi WúXiàn, and was remorseful for what he had done.</p>
        <p>However, Jīn Líng didn’t expect Wèi WúXiàn to have an easygoing attitude on the matter; he reacted as if the rumours were not about him.</p>
        <p>“I didn’t mean it.” said Jīn Líng.</p>
        <p>“I know that, already.” kindly said Wèi WúXiàn.</p>
        <p>For fun, Jīn Líng made-up stories about Yílíng Lǎozǔ, and most of them were easy to see that they were fake. So, Jīn Líng was certain that none would take them seriously.</p>
        <p>One of his made-up stories was saying that Yílíng Lǎozǔ used his demonic power to transform his body, and give birth to HánGuāng-Jūn’s son.</p>
        <p>However, whenever a story included the name of Yílíng Lǎozǔ, even if it sounded unlikely to be true, people would undeniably take it as truth.</p>
        <p>So, from his made-up story born the rumours such as, in order to transform his body, Yílíng Lǎozǔ kidnapped hundreds of girls. Or, the reason why Yílíng Lǎozǔ gave birth to a son was that he wanted their child to seize the position of the next head of GūsūLán.</p>
        <p>None of those people cared to check if Yílíng Lǎozǔ really gave birth to a son who would usurp the position of the head of the sect.</p>
        <p>Since he had survived and crawled out of the burial mound, and became the master of the demonic power, therefore, he could also change into a woman, and give HánGuāng-Jūn a bunch of children.</p>
        <p>Jīn Líng asked, “Why is it that as long as you are involved, no matter how implausible the rumour is, people will believe it?”</p>
        <p>Wèi WúXiàn thought for a moment, then replied, “That’s because in their eyes I’m not a living person.”</p>
        <p>Perplexed, Jīn Líng asked, “What do you mean by that?”</p>
        <p>Wèi WúXiàn put his both hands on the back of his head, and lay on the grass with his legs crossed.</p>
        <p>The sunlight was showering on him, making his face glow in the way that seemed illusory.</p>
        <p>He slowly replied, “I am a symbol. A symbol of a devil. They don’t care about how I look like, or what I have achieved. However, they can’t live without using me as a topic of their gossips.</p>
        <p>“After their tattles, they go back to their business, and none of them cares about me as a person.”</p>
        <p>For those people, gossiping about Yílíng Lǎozǔ was part of their entertainment and recreation.</p>
        <p>After satisfying their curiosity, dissipating their boredom, venting their disapproval, and establishing a moral superiority over Yílíng Lǎozǔ, everything was forgotten, and none of them was accountable for their gossips.</p>
        <p>“What should we do, then?” Jīn Líng couldn’t help but ask.</p>
        <p>“There’s nothing we can do about it.” replied Wèi WúXiàn, “As I am a symbol in their eyes, are they not also a symbol in my eyes?</p>
        <p>“Those people have nothing to do with me, so do I to them. Therefore, there’s no need to care about it.”</p>
        <p>Wèi WúXiàn carried on, “A-ling, sometimes if you don’t respond is also a response. Do you remember the case of MòlíngSū clan?”</p>
        <p>“Yes I do.”replied Jīn Líng, “Last month, MòlíngSū clan accused GūsūLán of condoning your evil deeds. And also, there were rumours saying that GūsūLán had taken the MòlíngSū’s Night Hunting territory.”</p>
        <p>“And, how did GūsūLán respond?” Wèi WúXiàn asked.</p>
        <p>Jīn Líng thought for a moment, then replied, “GūsūLán paid no heed to their accusations.”</p>
        <p>“That’s right.” said Wèi WúXiàn, “If GūsūLán had responded to them, I’m afraid that there would be endless back and fourth arguments between GūsūLán and MòlíngSū clan.”</p>
        <p>A dispute between a larger clan and a smaller one, no matter what the outcome would be, people would regard GūsūLán and MòlíngSū clan as equal, which would lower GūsūLán’s status while raising the status of MòlíngSū clan.</p>
        <p>Furthermore, no matter how you would deal with it, you would be accused of bullying the weak clan.</p>
        <p>Wèi WúXiàn resumed, “So, it’s better to ignore them, and let those rumours fade away.</p>
        <p>“Those, who gather and enjoy watching the show, will be disappointed if there is no show to watch, and will soon get bored, and, eventually, they will start to disperse.</p>
        <p>“As for the rumours of the MòlíngSū’s Night Hunting territory, GūsūLán doesn’t need to seize it, and, this fact, everyone knows it.”</p>
        <p>Jīn Líng then wondered, “Why do the rumours about GūsūLán don’t go out of control? Last month, people were gossiping about GūsūLán. But now, they’re no longer talking about it.”</p>
        <p>“It’s probably because they still need GūsūLán to get rid of evil spirits and demons. Unlike me, who is a little bit inactive.” said Wèi WúXiàn.</p>
        <p>“Besides,” he carried on while smiling to himself, “for more than twenty years, I have gained notoriety for being a dreadful opponent, and it’s almost impossible to change it in people’s mind”</p>
        <p>“It saddens you that you can’t change the way people see you?” Jīn Líng asked, then realised that it was a stupid question. With Wèi WúXiàn’s personality, he would certainly reply “I don’t care”.</p>
        <p>However, Wèi WúXiàn said, “What makes me sad is the fact that Lán Zhàn is also dragged into this mess.”  He looked a little bit down after saying that.</p>
        <p>Jīn Líng had never seen Wèi WúXiàn looking depressed, so he didn’t know how to comfort him.</p>
        <p>In a low voice, Jīn Líng said, “Right now, there is a lot of storybooks about HánGuāng-Jūn and you.”</p>
        <p>“Yes, indeed.” Wèi WúXiàn let out a sigh.</p>
        <p>In those stories, they changed his HánGuāng-Jūn from an awe-inspiring martial cultivator to an immoral character.</p>
        <p>People behind those storybooks might or might not have malicious intentions. However, there was nothing he could do about it.</p>
        <p>Even himself could not help but read one of those stories, which was titled ‘The Hooligan HánGuāng-Jūn Imprisons Yílíng Lǎozǔ’.</p>
        <p>“It’s so awfully exciting to read it!” said Wèi WúXiàn inwardly, and he was no longer feeling down.</p>
        <p>Then, he said, “Since Lán Zhàn said that he didn’t care what people are saying about him, then there is no longer a need for me to care about it, either.</p>
        <p>“After all, they are just a bunch of insignificant people who spend their time spouting nonsense.”</p>
        <p>Wèi WúXiàn only cared about his HánGuāng-Jūn. Likewise, Lán WàngJī also only cared about his Wèi Yīng. So, no matter how rampant the rumours were, both of them just carried on living their lovely life as a couple.</p>
        <p>However, Jīn Líng was still unhappy about the matter, so Wèi WúXiàn gently patted his shoulder in a comforting manner, and said, “A-ling, you should always remember what people have done for you, and not what you have done for them.</p>
        <p>“And you should not fill your mind with useless stuff, so that you can be free and happy. These are what my mother told me.”</p>
        <p>“Your mother really told you that?” Jīn Líng asked.</p>
        <p>“Of course.” replied Wèi WúXiàn, “Now, I passed it on to you.”</p>
        <p>“You are preaching, again.” muttered Jīn Líng.</p>
        <p>Then, he turned his head to look at him. Wèi WúXiàn’s smiling eyes were shining like stars, and filled with sweetness.</p>
        <p>Even though, occasionally, sadness appeared on his face, however, it swiftly swept away, and his usual cheerful expression reappeared.</p>
        <p>“A-ling, it’s truly what my mother said.” reiterated Wèi WúXiàn, “I remember all your kindness and consideration towards me, and also what you have done for me.”</p>
        <p>Jīn Líng suddenly blushed at Wèi WúXiàn’s words.</p>
        <p>Wèi WúXiàn then stood up, and, gracefully, drew Suíbiàn. The red light wrapped around his sword was stunning.</p>
        <p>With his red hair ribbon fluttering in the air, Wèi WúXiàn said, “Come on, young Zōng-zhǔ, stop thinking about all this matter, and let’s practise.”</p>
        <p>Jīn Líng was still sitting on the grass, with the blushing expression that still lingered on his face. He just gazed vacantly at Wèi WúXiàn.</p>
        <p>“This time, I won’t go easy on you.” said Wèi WúXiàn, “Are you up to it?”</p>
        <p>Jīn Líng finally reacted and unsheathed Suìhuá, then proudly replied, “You bet! I won’t go easy on you, either.”</p>
        <p>The two of them fiercely exchanged moves with their swords being wrapped in red light for Suíbiàn, and in golden light for Suìhuá.</p>
        <p>When practising with Wèi WúXiàn, Jīn Líng always used the swordsmanship of the YúnmèngJiāng clan.</p>
        <p>Their both swordsmanships came from YúnmèngJiāng clan, and, as they fought, the two didn’t look like they were from two different generations. They were looking more like brothers.</p>
    </div>

export const Chap35 =
    <div>
        <br />
        <p>A few days later, Jīn Líng paid another visit to Yúnshēn Bùzhīchù.</p>
        <p>“You let chief instructor Zhāng join LánlíngJīn sect!” exclaimed Wèi WúXiàn, who was surprised to see that Jīn Líng had acted faster than Jiāng Chéng.</p>
        <p>“That’s right.” Jīn Líng proudly replied, “When the rumours of Wěishàn Village started to spread, I thought that he would be in trouble.</p>
        <p>“As expected, his superiors put the blame of those rumours on him, and, soon after, he was dismissed from his post.”</p>
        <p>Since LánlíngJīn took in chief instructor Zhāng, the sect now could be regarded as his salvation.</p>
        <p>“You have acted very quickly.” said Wèi WúXiàn, “So, what do you plan on doing next?”</p>
        <p>“Nothing for the moment.” replied Jīn Líng, “I’ll wait. There’s no rush.”</p>
        <p>Indeed, it would be inappropriate to ask how the authorities had handled Wěishàn Village’s matter to chief instructor Zhāng straight away. They needed to find a suitable time to bring the topic to the table.</p>
        <p>Wèi WúXiàn was happy about it, however, he could not help feel a little bit disappointed for the wait.</p>
        <p>“A-Líng, you become more coolheaded.” said Wèi WúXiàn,  “You’ve even come to discuss it with me. Young Zōng-zhǔ, you have grown up.”</p>
        <p>Surely enough, Jīn Líng had become more mature, clever and decisive. He had also gained insight in worldly affairs, and experience in social relationship.</p>
        <p>This was a good thing for Jīn Líng to become an adult, since he was the leader of LánlíngJīn sect.</p>
        <p>Wèi WúXiàn was happy for Jīn Líng, however, for now, his desire was to see him stay a kid for a little while, because they had not spent a lot of time together.</p>
        <p>He wanted to catch up on years he had missed when Jīn Líng was still a child, he wanted to spoil him for a while.</p>
        <p>With his face slightly turned red, Jīn Líng said, “I came here only to let know you about it, not to discuss it with you.”</p>
        <p>“All right, so be it.” said Wèi WúXiàn, “A-Líng, I’m really happy to see how hard you are working for my sake.”</p>
        <p>He then added, “A-Líng, thank you.”</p>
        <p>“Why are you thanking me for?” said Jīn Líng, while blushing even more, “I didn’t do it for you. And I don’t care about you.”</p>
        <p>Wèi WúXiàn shrugged his shoulders, and said, “Okay, then. Anyway, I still want to thank you.”</p>
        <p>With his ears and neck slightly tinted in red, Jīn Líng turned his head away from Wèi WúXiàn.</p>
        <p>After staring for a short while at the white rabbits hopping about, Jīn Líng then murmured, “Thank you, too.”</p>
        <p>“What did you say?” asked Wèi WúXiàn.</p>
        <p>“Thank you for the ring.” said Jīn Líng in a low voice, “I already know that for my one-month-old celebration you crafted it for me as a gift.”</p>
        <p>“Oh!” uttered Wèi WúXiàn, “I will give you a more powerful gift.”</p>
        <p>Jīn Líng stayed silent, he involuntarily touched the ring on his left thumb, and began to fiddle with it.</p>
        <p>Often, in his head, he would call it ‘The Supreme Mythical Peerless Precious Ring’. However, he never said it out loud, because the name was too verbose.</p>
        <p>Wèi WúXiàn watched him playing with the ring for a short while, then, he said, “A-ling, I remember something.”</p>
        <p>“What is it?” Jīn Líng asked.</p>
        <p>“I remember that you called me ‘uncle Wèi’. Did I hear you wrong?” uttered Wèi WúXiàn.</p>
        <p>Jīn Líng suddenly felt embarrassed, and began to stammered, “I... I...I’m not ready yet.”</p>
        <p>“It’s all right.” Wèi WúXiàn gently said. Then, he took Jīn Líng in his arms, and began to ruffle Jīn Líng’s hair.</p>
        <p>At least, his little Jīn Líng was thinking about it. Right now, he needed some time before he could naturally call him ‘uncle’.</p>
        <p>So, Wèi WúXiàn didn’t mind waiting for that time to come, and was looking forward to it.</p>
        <p>Jīn Líng started to struggle to set himself free from Wèi WúXiàn’s cuddle, “What’s wrong with you? And stop messing up my hair.”</p>
        <p>Then, they heard some faint noise of footsteps, and turned their heads towards the coming sound.</p>
        <p>Wearing snow-like white clothes, Lán WàngJī was looking so graceful as through he was some kind of heavenly being.</p>
        <p>Seeing that it was Lán WàngJī who was coming towards them, Jīn Líng struggled even harder.</p>
        <p>Wèi WúXiàn firmly held Jīn Líng, while waving at Lán WàngJī, “Lán Zhàn! Hurry up!”</p>
        <p>And, without letting out a sound, Wèi WúXiàn moved his lips saying, “Hug us.”</p>
        <p>Upon reaching them, Lán WàngJī hesitated for a brief second, then, he cooperated with Wèi WúXiàn, and hugged the two of them.</p>
        <p>Jīn Líng immediately stopped struggling, and stayed still. His head was leaned against Wèi WúXiàn’s chest, and he could clearly hear Wèi WúXiàn’s heartbeat.</p>
        <p>He was right in middle, surrounded by Wèi WúXiàn and Lán WàngJī.</p>
        <p>Being hugged by Wèi WúXiàn was okay for Jīn Líng. However, when it was Lán WàngJī who hugged him, he felt a little bit frightened.</p>
        <p>Jīn Líng was a twenty-years-old young man already, however, right now, it seemed to him that he had been treated as though he was still a child.</p>
        <p>Furthermore, Jīn Líng got the feeling that they were doing even more shocking thing above his head, which caused him to be petrified.</p>
        <p>In fact, Lán WàngJī only kissed Wèi WúXiàn slightly on the forehead, then, he leaned his own forehead against Wèi WúXiàn’s forehead, and both of them remained like this without doing anything else.</p>
        <p>The sky above them was high and blue with some thin cirrus clouds looking like they were painted, and the grass beneath them was green and luxuriant with lovely colourful wildflowers. Like a caress, a gentle breeze completed the picture of this beautiful scenery.</p>
        <p>Inwardly, Wèi WúXiàn said, “The ones I love and care about the most, also love and care about me, are right now by my side.</p>
        <p>“There is a little bit of commotion out there. However, here is Yúnshēn Bùzhīchù, GūsūLán residence, where time is quiet and peaceful.”</p>
        <br />
        <p>... ... ...</p>
        <br />
        <p>The ten-mile of the lotus pond was a beautiful scenery with the refreshing breeze gently blowing. However, its owner was feeling depressed and irritable.</p>
        <p>Jiāng Chéng never liked to deal with the authorities. For a long time, each of them had carried out their business without interfering with each other.</p>
        <p>And the time when Jiāng Chéng asked the authorities for help had gone long ago; the Shooting Sun campaign, the reconstruction of Lotus Piers, and the revival of YúnmèngJiāng sect, those devastated periods were already buried.</p>
        <p>Back then, he was a young and weak leader, surrounded by powerful opponents. He didn’t want to ask for help, however, it was his only option. He didn’t like to socialise, but he had to learn how to be social.</p>
        <p>When the sect became more stronger, Jiāng Chéng gradually reduced his interactions with the authorities.</p>
        <p>However, right now, he had to interact with them again, because the bad rumours about Wèi WúXiàn were originated from Yúnmèng territory.</p>
        <p>A few days ago, when Jiāng Chéng had a small gathering with several influential personalities, one of them indirectly asked whether YúnmèngJiāng sect was behind all those rumours.</p>
        <p>Even the small sects that were affiliated to YúnmèngJiāng sect also had such speculation.</p>
        <p>“How ridiculous!” thought Jiāng Chéng, “If I wanted to deal with Wèi WúXiàn, why would I use such means?”</p>
        <p>After the incident at the Guanyin Temple, Jiāng Chéng became extremely sensitive to provocations. So, he ordered someone to deliver a card announcing his visit to the prefect’s office.</p>
        <p>However, when Jiāng Chéng had a meeting with the prefect, the latter’s attitude was very ambiguous.</p>
        <p>Jiāng Chéng realised that the authorities would not help clarify the matter. So, he hinted that YúnmèngJiāng sect had to save face.</p>
        <p>The prefect then kindly smiled and promised to give him an explanation.</p>
        <p>Still, the authorities remained ambiguous about YúnmèngJiāng sect involvement on those rumours.</p>
        <p>So, Jiāng Chéng took a drastic measure in purchasing a piece of barren land from the authorities at a high price, on the border of Yúnmèng, to put an end on Wěishàn Village’s matter.</p>
        <p>Both parties agreed that, for the next two hundred years, the tolls imposed on merchants and travellers on this land would be collected by YúnmèngJiāng sect.</p>
        <p>The purchase money had been used to compensate the villagers. The authorities gave them the exact amount that was originally written on the compensation plan. Then, they closed the matter of Wěishàn Village, and the rumours gradually faded away.</p>
    </div>

export const Chap36 =
    <div>
            <br/>
            <p>“Wèi-qiánbèi, step back!” Lán JǐngYí cried out.</p>
            <p>About five or six feet away from them, there were two walking corpses staggering to their feet, with their tattered clothes that would fall off at the slightest breeze.</p>
            <p>As soon as they noticed the presence of Yílíng Lǎozǔ, the two copses got scared, and, immediately, turned around and began to run away just slightly faster than when they were walking towards them.</p>
            <p>Despite their ugly appearance and bad smell, those kind of walking copses didn’t pose any threat at all. Even a common person with a physical strength could knock them down.</p>
            <p>Still, in a serious manner, Lán JǐngYí told Wèi WúXiàn to take cover behind him, then, he threw two talismans towards those walking copses, and, instantly, they were mobilised.</p>
            <p>Then, Lán SīZhuī gently plucked at the strings of his guqin, and released two spiritual strings that tied them up.</p>
            <p>Wèi WúXiàn amusingly clapped his hands, and said, “My two brave heroes are really amazing. You are the models of GūsūLán clan, young talents with outstanding grace. I feel completely at ease with you two protecting me.”</p>
            <p>Lán JǐngYí felt embarrassed and smiled awkwardly, “Sorry, Wèi-qiánbèi. I shouldn’t have shouted at you, just now.”</p>
            <p>“It’s okay. I’m here to make you both gain some experience.” replied Wèi WúXiàn.</p>
            <p>Lán SīZhuī earnestly said, “Wèi-qiánbèi, we all have decided to get stronger as soon as possible in order to protect you during Night Hunting.”</p>
            <p>Then, he added, “We were really worried about you when you went missing. Then, we were very sad when you didn’t recognise us, because you had lost your memories.</p>
            <p>“Just now, JǐngYí panicked, and yelled at you out of concern.”</p>
            <p>Wèi WúXiàn then smiled, and said, “In that case, from now on, I will trouble you two to protect me, a weak man.”</p>
            <p>Then, the three of them were lively chatting and laughing, while going back to the small village they had left earlier.</p>
            <p>Today, Wèi WúXiàn had brought several teenagers along for Night Hunting. And, upon their arrival, they met some authorities’ staff who had requested help, as well as coming across an old man, who was a firewood seller living in a remote village in the mountains.</p>
            <p>After checking and noting that the evil spirits in the town were not hard to handle, Wèi WúXiàn decided to take Lán SīZhuī and Lán JǐngYí along to the village with the old man, and leave the rest of the teenagers to deal with the town governor’s request.</p>
            <p>And, in case an unexpected incident occurred while he was away, someone from GūsūLán villa nearby would be there in no time to assist the teenagers.</p>
            <p>Taking Lán SīZhuī and Lán JǐngYí along was not initially Wèi WúXiàn’s plan. These youngsters didn’t want to let him act on his own, so they insisted to tag along.</p>
            <p>The village was built deep in the mountains with small alleys and lanes between the houses. Upon entering the village, one could smell the fragrance of flowers in the air, hear birds singing from the surrounding trees, and perceive the faint gurgling sound of a stream.</p>
            <p>With a thin mist lingering at the top of the mountains, the small village emanated a warm and cosy ambience.</p>
            <p>As the three of them reached the village, after getting rid of walking corpses, they heard a dog barking from a courtyard.</p>
            <p>With his fear of dogs, Wèi WúXiàn hid himself behind Lán SīZhuī and Lán JǐngYí for fear that the dog would jump out of the courtyard and attack him.</p>
            <p>Walking behind these two teenagers, Wèi WúXiàn felt indeed at ease and protected.</p>
            <p>As soon as he saw them, the village chief, with a sincere smile on his face, walked towards Wèi WúXiàn and the two teenagers, and thanked them.</p>
            <p>In addition of being grateful to them, the villagers didn’t expect to receive three immortal-like cultivators from an outstanding sect in their isolated village.</p>
            <p>For quite a long time, walking corpses had been a problem for those villagers. Luckily enough, they didn’t cause any harm, except scaring people.</p>
            <p>Then, the three of them were warmly invited to stay for dinner, and were served with some delicious local dishes, namely ground pot chicken, spicy steamed beef, fried diced pork in bean sauce, potato dumplings, crispy stuffed lotus root, and fried eggs with toon leaves.</p>
            <p>Although Lán WàngJī had been cooking for him, and, each time, making his favourite dishes, Wèi WúXiàn wasn’t a picky eater when he was away, and was satisfied eating deep fried dishes.</p>
            <p>As for Lán SīZhuī and Lán JǐngYí, who usually ate Yúnshēn Bùzhīchù’s bland and unseasoned dishes, they were always happy when they could eat something else, for change.</p>
            <p>Noting that the three cultivators were not arrogant, the villagers became more relaxed around them, and the village chief brought a jar of wine for them to taste.</p>
            <p>“We will pour it ourselves.” said Wèi WúXiàn.</p>
            <p>The two teenagers only half-filled their cups, then, Lán JǐngYí, overexcited, gulped down his cup of wine, and, instantly, he began to cough.</p>
            <p>“JǐngYí, you’re really not good at tasting wine.” said Wèi WúXiàn while laughing. “You need more practice.”</p>
            <p>Then, he drank his filled cup in one gulp. As the beverage travelled down to his stomach, Wèi WúXiàn felt a warm sensation spreading out gradually in his whole body.</p>
            <p>“This wine is really tasty.” commented Wèi WúXiàn.</p>
            <p>Although he had tasted countless of wines, Wèi WúXiàn was still impressed by the flavour of their wine.</p>
            <p>“Is the taste of wine too strong?” asked the village chief. “It is brewed to be especially rich and strong. We have chosen to name it Burning Campfire.”</p>
            <p>“What an excellent name!” Wèi WúXiàn praised. “It’s worthy of this wine.”</p>
            <p>He filled his cup once more, and gulped the wine with delight. Then, he said, “It is indeed rich and strong with a little taste of sweetness.”</p>
            <p>With his cheeks already turned red, Lán JǐngYí was feeling dizzy, and his drunk appearance made the villagers smile.</p>
            <p>They brought a cup of water for Lán JǐngYí to sober up. However, after drinking water, he was still drunk, and collapsed on the table.</p>
            <p>Lán SīZhuī didn’t dare to pour more wine into his cup, and Wèi WúXiàn could not help laughing at them, then decided that it would be better for himself to drink more slowly.</p>
            <p>Noting that Wèi WúXiàn could hold his alcohol, the village chief joined him, and, together, they began to drink.</p>
            <p>After drinking too much wine, the village chief began to talk about their farming, such as whether he should grow rice or millet, sow potatoes or radishes, and so on. Then, he moved on talking about the number of cattle and sheep they bred in the village, as well as chickens and ducks.</p>
            <p>Wèi WúXiàn was a talkative and easy-going type of guy. He could have a good chat with people on their family issues, as well as discussing ordinary farming work.</p>
            <p>Lán SīZhuī was really impressed. It was the first time for him to notice how his Wèi-qiánbèi was versed in so many subjects, and how easily he could discuss with the village chief about any topics brought into their conversation.</p>
            <p>Both guests and hosts had a good time during the meal, as well as during their drinking session after they had done eating.</p>
            <p>Noting that Wèi WúXiàn enjoyed their wine, the villagers brought several jars of Burning Campfire, and told him to put them in his qiánkūn-dài*, and to carry them with him.</p>
            <small>*qiánkūn-dài is a dimensionless bag that can hold more stuff than an ordinary bag.</small>
            <p>Wèi WúXiàn really liked their wine, and, since he was not a shy person, he accepted their offering with enthusiasm.</p>
            <p>On their journey to this village, the two teenagers didn’t let Wèi WúXiàn drive Suíbiàn on his own. Lán SīZhuī had taken Wèi WúXiàn on his sword, while Lán JǐngYí flew with the old man.</p>
            <p>Now that Lán JǐngYí was drunk and asleep, and since they had a long journey ahead, Wèi WúXiàn decided to fly on his own, and asked Lán SīZhuī to carry Lán JǐngYí.</p>
            <p>The villagers saw them off at the entrance of their village, and, suddenly, the village chief said, “We have kept calling you ‘immortal cultivator’, and have forgotten our manners. Could you please tell us your name, so, in future, everyone will remember it?”</p>
            <p>The request startled Wèi WúXiàn a little bit, then, calmly, he replied, “My name is Wèi WúXiàn.”</p>
            <p>“Wèi WúXiàn. It’s truly a good name.” praised the village chief, “It’s worthy of someone who knows how to appreciate wines. It’s a very suitable name for an immortal cultivator as yourself.”</p>
            <p>Wèi WúXiàn was used to see people getting terrified and staying away from him once they heard his name. This was the first time in a quite while that he heard someone praising his name.</p>
            <p>With his heart filled with joy and happiness, Wèi WúXiàn stepped on Suíbiàn, and, while flying away, he quietly looked at the small village in the mountains.</p>
            <p>Then, inwardly, he said, “Lán Zhàn, it’s great to go Night Hunting wherever evil spirits cause trouble for common people.”</p>
            <p>Even though the compensation rumours involving GūsūLán died away, Yílíng Lǎozǔ’s notoriety would never fade away.</p>
            <p>Wèi WúXiàn, however, didn’t give a damn about it, because, now, he had so many people who wanted to protect him.</p>
            <p>Lán XīChén had come out of his seclusion, and his move was amazingly successful.</p>
            <p>At first, Jīn Líng was anxious about it. Then, he tried his best, and, gradually, became mature.</p>
            <p>Although Jiāng Chéng didn’t keep in touch with him, Wèi WúXiàn was sure that he had also spent a lot of effort on the matter.</p>
            <p>Furthermore, all the young disciples of GūsūLán really liked him. And, for his sake, they wanted to get stronger to protect him.</p>
    </div>

export const Chap37 =
    <div>
            <br/>
            <p>Since Lán JǐngYí was drunk, Wèi WúXiàn asked the teenagers to stay in town for the night, and return home the next day when Lán JǐngYí became sober. Otherwise, he would be punished by copying the GūsūLán rules.</p>
            <p>Wèi WúXiàn then stepped on Suíbiàn and flew as faster as he could so to reach Yúnshēn Bùzhīchù before curfew.</p>
            <p>Holding a lantern, Lán WàngJī was standing in front of the gate, waiting for Wèi WúXiàn to return. And, as he saw him coming, his eyes lit up.</p>
            <p>To welcome his Wèi Yīng, Lán WàngJī released from his fingertips some blue spiritual light in form of butterflies, which, flapping delicately their wings, flew to meet Wèi WúXiàn, then moved in circle around him as he was getting closer to his HánGuāng-Jūn.</p>
            <p>Jumping off from his sword, Wèi WúXiàn’s heart was beating faster than ever, his breathing also quickened up, he was no longer as calm as when he was travelling back home.</p>
            <p>It was an overwhelming feeling for him to think that such a good-looking man belonged to him. Moreover, he was waiting for him to come home.</p>
            <p>This was by far more precious to him than countless treasures in the world, and he was no longer afraid of other people trying to spoil his happiness.</p>
            <p>Without saying a single word, both of them walked quickly towards each other to close the distance that separated them.</p>
            <p>Then, surrounded by the blue butterflies, they hugged each other tight in front of the main entrance, and the sandalwood fragrance emanated from Lán WàngJī wrapped them up.</p>
            <p>In a coquettish way, Wèi WúXiàn touched one of the two hanging parts of Lán WàngJī’s forehead ribbon, brought it in front by sliding his fingers slowly along the ribbon, then, he rolled it around his index finger.</p>
            <p>Teasingly, he said, “Èr-gēge, what’s wrong with you hugging me so tight, after not seeing me for just one day? The disciples who are in charge of guarding the gate will see us.”</p>
            <p>Lán WàngJī replied, “I have blocked you from their view.”</p>
            <p>“Even though they can’t see me, do you think they won’t know what we are doing?” said Wèi WúXiàn, “HánGuāng-Jūn, since when you become self-deceiving?”</p>
            <p> “I am outside Yúnshēn Bùzhīchù.” said Lán WàngJī.</p>
            <p>Since they were standing outside the GūsūLán residence,  the rules of their sect were not applicable to them. And, in the past, Wèi WúXiàn had made use of this trick to avoid punishment.</p>
            <p>Wèi WúXiàn said, “As the saying goes, one takes on the colour of one’s company. It seems like HánGuāng-Jūn gets influenced by Wèi WúXiàn.”</p>
            <p>Lán WàngJī slightly frowned, then, earnestly, he looked at Wèi WúXiàn and said, “It’s true that being in a good company will influence your behaviour. Wèi Yīng, you are not a bad company to me.”</p>
            <p>Wèi WúXiàn laughed.</p>
            <p>Then, Lán WàngJī sensed a different smell of alcohol than that of Emperor Smile, and asked, “Wèi Yīng, did you drink alcohol?”</p>
            <p>“Yes, I did.” replies Wèi WúXiàn, “Today, I went to a remote village to get rid of evil spirits, then, after that, I drank a lot of wine with the chief of the village.”</p>
            <p>He then asked, “Did you smell it on my breath? Would you like to taste it?”</p>
            <p>With a seductive look in his eyes, Wèi WúXiàn slightly bit his own lower lip with his pearl-like teeth, then, invitingly, he stuck out the tip of his tongue between his soft lips.</p>
            <p>As a result, Lán WàngJī could not help his Adam’s apple to bob up and down. However, he restrained himself by kissing Wèi WúXiàn only slightly. And, when the latter pressed his own lips against his to deepen their kiss, Lán WàngJī drew back.</p>
            <p>“I can’t let myself get drunk right now.” said Lán WàngJī, “I have prepared a gift for you, and I want to give it to you before getting drunk.”</p>
            <p>“How do you know for sure that a deep kiss will get you drunk?” asked Wèi WúXiàn.</p>
            <p>“Because the wine you drank is by far stronger than Emperor Smile.” replied Lán WàngJī.</p>
            <p>“How can you tell?” asked Wèi WúXiàn.</p>
            <p>Lán WàngJī replied, “Although I am not good at drinking, however, I learned more about the wines, because you like to drink them so much.”</p>
            <p>Wèi WúXiàn chuckled. Then, he stood on tiptoe and gave Lán WàngJī an affectionate kiss on the cheek.</p>
            <br />
            <p>... ... ...</p>
            <br />
            <p>A warm moonlight showered on them as they reached Jingshi. The magnolia tree was in full bloom with its white flowers. However, the fragrance of its blossoms was overpowered by the delicious smell of the food coming from the room.</p>
            <p>Wèi WúXiàn quickly walked into the room, and saw several dishes on the table, namely, spicy shrimp balls, Dong’an chicken, crabs in spicy sauce, and steamed fish head with chopped red pepper.</p>
            <p>There were also some vegetable dishes such as fresh corn, bamboo shoot and lotus root. And, all these dishes were his favourite, and were meticulously presented.</p>
            <p>Wèi WúXiàn was overjoyed, and said, “Èr-gēge, you are so amazing! This is so splendid! Is this table of delicious looking dishes the gift you have prepared for me?”</p>
            <p>Lán WàngJī slightly smiled, then replied, “Not at all.”</p>
            <p>Then, he started to peel the crabs, while Wèi WúXiàn took a plate and filled it with various food, then presented it to Lán WàngJī.</p>
            <p>He said, “Stop peeling the crabs, I’ll do it myself. You surely haven’t eaten yet. Let’s eat together.”</p>
            <p>“Okay.” agreed Lán WàngJī.</p>
            <p>He then put the crab meat he had already peeled into a plate, and gave it to Wèi WúXiàn, and then, they started eating.</p>
            <p>Wèi WúXiàn began to talk at length about what happened during their Night Hunting. And, from time to time, he would suddenly ask about the gift that Lán WàngJī mentioned earlier.</p>
            <p>However, Lán WàngJī didn’t fall for Wèi WúXiàn’s stratagem, and, each time, he would reply either “Don’t speak while eating.” or “We’ll talk about it after the dinner.”</p>
            <p>In the end, Wèi WúXiàn gave up, and focused on savouring every mouthful of the delicious food that Lán WàngJī cooked for him, while praising Lán WàngJī for each dish.</p>
            <p>After the meal, the two of them went to the backyard. The sky above them was clear and filled with stars, the moonlight fell on the magnolia blossoms, and their surroundings were quiet and peaceful.</p>
            <p>Lán WàngJī took out a velvet box from his sleeve, opened it and revealed a pure white bracelet with a knotted hair around it.</p>
            <p>He said, “I did the same thing as you did before, putting my knotted hair around the bracelet.”</p>
            <p>Then, he knelt down on one knee, in front Wèi WúXiàn, and said, “Wèi Yīng, congratulation for forming a new golden core.”</p>
            <p>Greatly touched, Wèi WúXiàn took the bracelet, and wore it on his left wrist. Then, the two of them hugged each other tight.</p>
            <p>“Lán Zhàn.” Wèi WúXiàn called in a very low and inviting voice, wanting to be carried to the bed.</p>
            <p>So, Lán WàngJī did, he held him in his arms, and walked into the room.</p>
    </div>

export const Chap38 =
    <div>
            <br/>
            <p>Wèi WúXiàn had already become horny, he slid his hands beneath Lán WàngJī’s clothes, and began to fondle Lán WàngJī’s upper body.</p>
            <p>“Wèi Yīng, wait a minute.” Lán WàngJī hurriedly said.</p>
            <p>While trying to remove Lán WàngJī’s top clothes, Wèi WúXiàn asked, “Why should I wait?”</p>
            <p>“Because I have another gift for you.” replied Lán WàngJī.</p>
            <p>The revelation of another gift seemed to surprise Wèi WúXiàn a little bit. And, every time Lán WàngJī wanted to give him a present, he would try hard to behave. So, he tidied up Lán WàngJī’s clothes.</p>
            <p>He then asked, “Why are you holding me in such an ambiguous way when you are not in a hurry to take me to the bed?"</p>
            <p>“Am I not allowed to carry you like this?” retorted Lán WàngJī.</p>
            <p>Then, while still holding Wèi WúXiàn in his arms, Lán WàngJī walked to the bookshelf, and stopped where a gorgeous blue brocade box with cloud motifs was.</p>
            <p>Wèi WúXiàn opened the box and saw several volumes inside. He took out one volume while noting that they were all untitled.</p>
            <p>Lán WàngJī replied to his unspoken question, “It’s up to you to choose a title for each of the volumes.”</p>
            <p>Puzzled, Wèi WúXiàn opened the volume and began to turn the pages. As he kept on skimming through the volume, Wèi WúXiàn became more and more astonished; it was a collection of his own manuscripts on demonic power methods.</p>
            <p>“Lán Zhàn, this is...” overly dumbfounded, Wèi WúXiàn was not able to finish his sentence. He had never been diligent in writing a book. He always scribbled his work randomly.</p>
            <p>However, unknown to him, Lán WàngJī had progressively gathered his random scribbles into a compilation.</p>
            <p>“Lán Zhàn, this must have taken you a tremendous amount of time to complete it.”</p>
            <p>“Wèi Yīng, the elders have all agreed that once your gold core is formed, you can take up a formal teaching position, and teach the demonic power methods.” said Lán WàngJī.</p>
            <p>“What?!” Wèi WúXiàn cried out, and almost jumped up, as if he was struck by lightning.</p>
            <p>It was a great honour to have a teaching position in GūsūLán clan. And, the most incredible thing was that they allowed him to teach the demonic power methods!</p>
            <p>“How could they agree on this?” asked Wèi WúXiàn, while thinking that this matter was very delicate for a respectable sect like GūsūLán, and could not possible be settled that easily.</p>
            <p>Lán WàngJī replied, “After many rounds of discussion, the elders have finally consented to my request in letting you become a teacher.”</p>
            <p>He carried on, “Demonic powers also have many useful uses. Instead of letting those who practise on their own going astray, it’s better that you teach and supervise them, as well as setting rules and regulations.”</p>
            <p>Still holding the volume, Wèi WúXiàn was speechless, and his hands were slightly trembling, he couldn’t believe his ears.</p>
            <p>“So, in other words,” thought Wèi WúXiàn, “when we started the dual cultivation, Lán Zhàn was sure that I would form a new golden core, and began to debate the teaching position with his uncle and the elders.</p>
            <p>“Then, I lost my memories, he sent an invitation letter to Mián-Mián to come to Yúnshēn Bùzhīchù along with her husband and daughter.</p>
            <p>“Lán Zhàn went all out to do all this for my sake.”</p>
            <p>In a lovely and tender tone, Lán WàngJī said, “Wèi Yīng, you are the founder of the demonic power. Therefore, you are the most suitable person to teach others how to use this power.”</p>
            <p>Then, he sincerely added, “Wèi Yīng, you have a lot of talent, there’s no need to hide it.”</p>
            <p>“Xiōng-zhǎng also said the same thing.” thought Wèi WúXiàn.</p>
            <p>He then tried to picture Lán WàngJī putting forward arguments in front the elders during their debating sessions.</p>
            <p>Lán WàngJī looked at him, and noticed that he was miles away. To get his attention, he gently kissed Wèi WúXiàn on the forehead, then, he asked, “Wèi Yīng, are you happy to take this teaching position?”</p>
            <p>Wèi WúXiàn suddenly wrapped his arms around Lán WàngJī’s shoulders, buried his face on Lán WàngJī’s neck, then let out a muffed “uh-huh” sound multiple times.</p>
            <p>Lán WàngJī chuckled, and said, “It’s settled, then.”</p>
            <p>Wèi WúXiàn then put the volume that he was holding back into the brocade box, and then, he slowly closed the box as though he was daydreaming.</p>
            <p>Suddenly, he felt uneasy and asked, “What if I ruin GūsūLán reputation by teaching demonic power methods? What if other sects decide not to send their people to attend courses here at Yúnshēn Bùzhīchù because of that?”</p>
            <p>Lán WàngJī reassured him, “You will not ruin the reputation of GūsūLán, and they will still come here, all of them.”</p>
            <p>“How can you be so sure?” Wèi WúXiàn asked.</p>
            <p>Proudly and confidently, Lán WàngJī replied, “Because it’s you, and no one else. You have a talent that is unparalleled. You are so brilliant that you are far ahead of others.”</p>
            <p>He carried on, “They all admire you, and are all envious of your talent. They want to catch up with you. Therefore, they will definitely come to learn your methods.”</p>
            <p>Wèi WúXiàn could read trust and admiration in Lán WàngJī’s eyes, which made him float on air.</p>
            <p>“Are you happy now?” asked Lán WàngJī.</p>
            <p>Wèi WúXiàn’s feeling of joy and happiness was beyond words that, after opening his mouth to reply, he couldn’t let out even an inaudible sound. So, he mindlessly nodded his head.</p>
            <p>Then, Lán WàngJī finally took him to the bed, and said, “Now, it’s my turn to receive a gift from you.”</p>
            <br />
            <p>... ... ...</p>
            <br />
            <p>The news that Yílíng Lǎozǔ would start to teach demonic power methods in autumn resounded like thunderclaps across the sky, and quickly spread among thunders of sects.</p>
            <p>All sects, small or large, held discussions about it, and the general opinion was that GūsūLán decision was a disrespect for their hundred years of good reputation. Some among them were disdainful, while others mocked their decision.</p>
            <p>Across the territories, HánGuāng-Jūn and Yílíng Lǎozǔ were once more at the forefront of the local gossip.</p>
            <p>All this ruckus carried on until the day of the enrolment to attend Yílíng Lǎozǔ’s class.</p>
            <p>Surprisingly, the first sect to arrive at Yúnshēn Bùzhīchù was QīnghéNiè. As the head of the sect, Niè HuáiSāng brought along a dozen of disciples for them to get enrolled.</p>
            <p>The next to arrive was a sect affiliated to QīnghéNiè, led by Ouyang Zizhen, who came with twenty young relatives.</p>
            <p>Standing at the gate to welcome guests, Wèi WúXiàn looked at a sleeping child whom Ouyang Zizhen was carrying in his arms, and could not help but laugh.</p>
            <p>Then, he asked, “Zizhen, who is this?”</p>
            <p>Ouyang Zizhen replied, “Wèi-qiánbèi, this is my young bother. He is seven years old, and has already started to learn the basics. Could you please accept him, as well?”</p>
            <p>While smiling, Wèi WúXiàn, in the same tone as Lán WàngJī’s, replied, “No, I can’t.”</p>
            <p>Then, he added, “He is too young to attend my class. What if he starts to cry during the lesson?”</p>
            <p>The following sects to arrive were all affiliated to YúnmèngJiāng. Soon after, the hesitant ones rushed in like a tsunami after seeing that many sects had already enrolled their young disciples.</p>
            <p>Among all those cultivators, who once wanted him dead while still using the devices that he had made, who didn’t know that Yílíng Lǎozǔ possessed a great talent. They were all eager not to miss out on learning Yílíng Lǎozǔ’s extraordinary skills.</p>
            <p>Yú XiǎoShān was the only one from MéishānYú sect to come at Yúnshēn Bùzhīchù. As the heir of his sect, strangely, he didn’t have any underlings, and seemed like he had run away from home.</p>
            <p>Since he didn’t want people to notice that he was alone, he sneaked in the group led by Ouyang Zizhen. In the afternoon, however, many members of his sect joined him.</p>
            <p>In the morning of the second day of the enrolment, after the hustle and bustle of the first day, six disciples from YúnmèngJiāng sect arrived.</p>
            <p>Despite of their small group, the YúnmèngJiāng disciples were the best among their fellows, and were known as the Six Pillars of the Lotus Piers. They were also close to Wèi WúXiàn.</p>
            <p>In defiance of Jiāng Chéng, LánlíngJīn sect arrived at Yúnshēn Bùzhīchù for the enrolment.</p>
            <p>Wearing his sword on the waist and a spear on his back, Jīn Líng defiantly said, “I don’t need to listen to my uncle. And I volunteered myself to be the last one to come here for you.”</p>
            <br />
            <p>... ... ...</p>
            <br />
            <p>In the evening, Lán WàngJī held Wèi WúXiàn tenderly in arms while thinking that his move was successful. Most sects had sent their close relatives and even their heirs to learn demonic powers.</p>
            <p>In the future, they would no longer have the right to slander his Wèi Yīng, or say that demonic power methods were heretical way of cultivating, that should be eradicated.</p>
            <p>And also, all those young disciples, who would attend Wèi WúXiàn’s class, would respect him as their teacher, and form a bond with him.</p>
            <p>“Wèi Yīng.” Lán WàngJī kissed Wèi WúXiàn with all love and passion he felt for him.</p>
            <p>Inwardly, Lán WàngJī said, “This wonderful person with an unparalleled talent is mine. He should found a sect and truly shine.”</p>
            <br />
            <p><b>Translator Note</b>:</p>
            <p>This is the end of our story. Thank you for reading my translation until the end. I hope that you had fun as much as I did in translating this side story of Lán WàngJī and Wèi WúXiàn. Next in the series is ‘<i>Lán WàngJī versus Alcohol</i>’. See you there!</p>
    </div>