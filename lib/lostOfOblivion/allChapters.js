...
export const ChapOne =
    <div>
        <p>“<MyAudio sound="/audio/weiqianbei.mp3" name="Wèi qiánbèi" />*...” cried <MyAudio sound="/audio/yuxiaoshan.mp3" name="Yú XiǎoShān" />, overwhelming with remorse.</p>
        <small>*qiánbèi: a title addressed to someone loder than oneself.</small>
        ...
        <p>However, right now, <MyAudio sound="/audio/weiwuxian.mp3" name="Wèi WúXiàn" /> spotted a pitch dark pond that they had overlooked. On close inspection, it was hard to determine the depth of the pond.</p>
        ...
        <p>Wèi WúXiàn smiled, and said, “<MyAudio sound="/audio/lanzhan.mp3" name="Lán Zhàn" />, this promises to be interesting.”</p>
        <p>All teenagers understood that there was a need to investigate the pond. So, full of energy, the disciples of the <MyAudio sound="/audio/yunmengjiang.mp3" name="YúnmèngJiāng" /> sect* were already gearing up to dive in. Each of them wanted to show their swimming skills to the teenagers of the <MyAudio sound="/audio/gusulan.mp3" name="GūsūLán" /> clan*.</p>
        ...
        <p>Yú XiǎoShān was the eldest grandson of the <MyAudio sound="/audio/meishanyu.mp3" name="MéishānYú" /> clan. Since he was a child, he had an outstanding spiritual power and extraordinary talent. Furthermore, he was highly praised when he was studying at Lotus Pier*.</p>
        ...
        <p><MyAudio sound="/audio/lanwangji.mp3" name="Lán WàngJī" /> said, “<MyAudio sound="/audio/weiying.mp3" name="Wèi Yīng" />*, I will dive with them because the water is too cold. However, <MyAudio sound="/audio/lanyu.mp3" name="Lán Yù" /> and <MyAudio sound="/audio/lanheng.mp3" name="Lán Héng" /> are not good at swimming. So, they will stay with you here, on the bank.”</p>
        ...
        <p>Yú XiǎoShān said to himself, “There is nothing special about this pond.” Then, he speeded up his pace, and, soon after, he saw the bubbles streaming upwards, and decided to follow their source.</p>
        ...
        <p><MyAudio sound="/audio/lanqi.mp3" name="Lán Qí" />, a teenager from GūsūLán clan, who had just stepped on his sword, but hadn’t the time to steady himself, was caught in the vortex.</p>
        ...
        <p>At the moment they saw Lán WàngJī turning his head towards them, some YúnmèngJiāng sect’s disciples hurriedly turned around to avoid eye contact. Lán <MyAudio sound="/audio/sizhui.mp3" name="SīZhuī" /> blindfolded Lán <MyAudio sound="/audio/jingyi.mp3" name="JǐngYí" /> with his hands, while closing his own eyes tight.</p>
...
export const ChapFive =
    <div>
        <p>As a matter of fact, <MyAudio sound="/audio/fangmengchen.mp3" name="Fāng MèngChén" />’s spiritual power was not great, nor was his swordsmanship, however, his moves were quick.</p>
        <p>He knew that <MyAudio sound="/audio/weiwuxian.mp3" name="Wèi WúXiàn" /> was running out of spiritual power, and noted that Wèi WúXiàn was not in a hurry to put an end to this fight, he only spent as less as possible his physical strength.</p>
        ...
        <p>This new pain in his leg helped Wèi WúXiàn to clear his head of the dizziness that he was experiencing, and, without losing any moment, Wèi WúXiàn cut off Fāng MèngChén’s arm which was brought within his reach, using his spiritual power that he transferred into <MyAudio sound="/audio/suibian.mp3" name="Suíbiàn" />.</p>
        <p>A stream of blood rushed in the air, and, in severe pain, Fāng MèngChén passed out instantly.</p>
        <p>Wèi WúXiàn then said, “The trick to cutting off arms, I must confess that I learned it from <MyAudio sound="/audio/lanzhan.mp3" name="Lán Zhàn" />.”</p>
        ...
        <p>--- --- ---</p>
        <br />
        <p>“My Lord, although Wèi WúXiàn is infamous, in fact, it is him who forms the bond between <MyAudio sound="/audio/gusulan.mp3" name="GūsūLán" /> and <MyAudio sound="/audio/lanlingjin.mp3" name="LánlíngJīn" /> sects, as well as the bond between GūsūLán and <MyAudio sound="/audio/yunmengjiang.mp3" name="YúnmèngJiāng" /> sects.</p>
        <p>“GūsūLán has no longer the desire to dwell on the past events related to Wèi WúXiàn. <MyAudio sound="/audio/jinling.mp3" name="Jīn Líng" />, the young leader of LánlíngJīn, holds no longer any grudge against Wèi WúXiàn. Even Leader Jiāng, the uncle of the young leader, has changed his attitude towards Wèi WúXiàn; this is due to the attachment between the young leader and Wèi WúXiàn.</p>
        <p>“In the past, <MyAudio sound="/audio/zewujun.mp3" name="Zéwú-Jūn" />, the leader of GūsūLán, <MyAudio sound="/audio/jinguangyao.mp3" name="Jīn GuāngYáo" />, the former leader of LánlíngJīn, and <MyAudio sound="/audio/chifengzun.mp3" name="Chìfēng-zūn" />, my Lord’s big brother and our former leader, were sworn brothers. Back then, the three of them had formed a strong alliance.</p>
        <p>“Even after our former leader had passed away, Zéwú-Jūn and Jīn GuāngYáo were still treating <MyAudio sound="/audio/qinghenie.mp3" name="QīnghéNiè" /> sect very kindly, and giving us their support every time it was needed.</p>
        <p>“At the present time, however, QīnghéNiè has no bond with any other sects, at all.”</p>
        <p>Holding a fan in his hand, <MyAudio sound="/audio/niehuaisang.mp3" name="Niè HuáiSāng" /> was slowly fanning himself, while quietly listening to his underling.</p>
        ...
        <p>Persistently, <MyAudio sound="/audio/lanwangji.mp3" name="Lán WàngJī" /> had since played his guqin, invoking and asking spirits the whereabouts of Wèi WúXiàn, until the strings of WàngJī broke off, cutting his fingers in the process. And the guqin was smeared with blood as a result of heavy bleeding.</p>
        ...
        <p>The underling resumed, “If Wèi WúXiàn happens to disappear without a trace, <MyAudio sound="/audio/hanguangjun.mp3" name="HánGuāng-Jūn" /> will be deeply devastated.</p>
        ...
        <p>Progressively, the appearance of <MyAudio sound="/audio/moxuanyu.mp3" name="Mò XuánYǔ" />, the summoner, had faded away, replaced by Wèi WúXiàn’s own face.</p>
        <p>Back when they were teenagers, and attending the school at <MyAudio sound="/audio/yunshenbuzhichu.mp3" name="Yúnshēn Bùzhīchù" />*, Wèi WúXiàn once said, “The spiritual power is the energy, and the resentment** is also the energy. </p>
        ...
        <p>Inside the <MyAudio sound="/audio/guanyin.mp3" name="Guānyīn" /> temple, Wèi WúXiàn asked, “Leader Niè, do you know what was inside of this now-empty coffin?”</p>
        ...
        <p>Niè HuáiSāng looked up into the sky, and, while gazing at the gorgeous fireworks, he nonchalantly said, “Spread the words of the <MyAudio sound="/audio/weishan.mp3" name="Wěishàn" /> villagers: ‘<MyAudio sound="/audio/yilinglaozu.mp3" name="Yílíng Lǎozǔ" /> forced us to leave our village, then flooded our homes, and destroyed the graveyard of our ancestors.</p>
        ...
        <p>Inwardly, Niè HuáiSāng said, “My dear <MyAudio sound="/audio/weixiong.mp3" name="Wèi-xiōng" />, I don’t have any intention of harming you. It’s just that the power between sects needs to be balanced.</p>
