...
export async function getAllChapters(chapId) {
	...
	const chapter11 = fs.readFileSync('./lib/lanWangJiVsAlcohol/chapters/chapter11.md', 'utf8');
	const chapter12 = fs.readFileSync('./lib/lanWangJiVsAlcohol/chapters/chapter12.md', 'utf8');
	const chapter13 = fs.readFileSync('./lib/lanWangJiVsAlcohol/chapters/chapter13.md', 'utf8');
	const chapter14 = fs.readFileSync('./lib/lanWangJiVsAlcohol/chapters/chapter14.md', 'utf8');
	const chapter15 = fs.readFileSync('./lib/lanWangJiVsAlcohol/chapters/chapter15.md', 'utf8');
	const chapter16 = fs.readFileSync('./lib/lanWangJiVsAlcohol/chapters/chapter16.md', 'utf8');
	...
	const dataSet = {
		...
		'11': {
			header: 'Lán WàngJī versus Alcohol: Chapter 11',
			leftImg: '/photos/lanWangjiVsAlcohol/bath_left.png',
		...
		'12': {
			header: 'Lán WàngJī versus Alcohol: Chapter 12',
			leftImg: '/photos/lanWangjiVsAlcohol/bath_left.png',
		...
		'13': {
			header: 'Lán WàngJī versus Alcohol: Chapter 13',
			leftImg: '/photos/lanWangjiVsAlcohol/bath_left.png',
		...
		'14': {
			header: 'Lán WàngJī versus Alcohol: Chapter 14',
			leftImg: '/photos/lanWangjiVsAlcohol/bath_left.png',
		...
		'15': {
			header: 'Lán WàngJī versus Alcohol: Chapter 15',
			leftImg: '/photos/lanWangjiVsAlcohol/bath_left.png',
		...
		'16': {
			header: 'Lán WàngJī versus Alcohol: Chapter 16',
			leftImg: '/photos/lanWangjiVsAlcohol/bath_left.png',
