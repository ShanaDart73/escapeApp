...
export const ChapOne =
	<div>
		...
		<p>He went on, “Right now, I am very annoyed, however, for your sake, I promise not to beat you to death.”</p>
		...
		<p>The more Wèi WúXiàn thought about the incident the more puzzled he became. Without wandering his eyes away Lán WàngJī, he asked, “Dà-gē*, you didn’t find what it is wrong with him either?”</p>
		...
		<p>There was also the hidden compartment under the floor where they put Emperor's Smile*. Apart from these modifications, there was nothing unusual in the room.</p>
		<small>*Emperor's Smile is Wèi WúXiàn’s favourite wine.</small>
		...
		<p>He went on, “WúXiàn, is it true that the monster you had encountered this time was very good at brewing wine?”</p>
		...
		<p>Noting a displeased expression on Lán Qǐrén’s face, Wèi WúXiàn thought, “I just can’t say: ‘Your nephew is very drunk. And the reason why he hasn’t woken up yet is because he can’t hold his liquor’.”</p>
		...
		<p>“What should I do now?” in panic, Wèi WúXiàn thought, “Is it too late to tell uncle that Lán Zhàn is drunk?</p>
...
export const ChapTwo =
	<div>
		...
		<p>“Tut,” thought Wèi WúXiàn, “This is the first time I find that the smell of alcohol can also be disgusting.”</p>
		...
		<p>Wèi WúXiàn shook his head helplessly and said, “If you can’t even handle his weight, then, you will need to practise harder.”</p>
		...
		<p>He went on, “If I want to bring them to their senses, I will need Lán Zhàn to play his Melody of Lucidity.”</p>
		...
		<p>He went on, “In order to find out what is wrong with this wine, I should take a few jars to study the wine later on, when we get back home.”</p>
		...
		<p>“Uncle, although it sounds unbelievable, however, WàngJī’s case is an exception,” Lán XīChén said, “It’s pity that WàngJī killed all the little monsters, and smashed all the jars that were filled with wine. Otherwise, we might have found some clues.”</p>
...
export const ChapThree =
	<div>
		...
		<p>“Of course, I’ll go with you. I can’t let you go by yourself,” Wèi WúXiàn reassured him.</p>
		...
		<p>Seeing that Lán Qǐrén’s face became gloomy, Wèi WúXiàn suppressed a chuckle, and secretly stuck his tongue out at him, then he thought, “Sorry, Lán Lǎo, I didn’t mean to upset you.”</p>
		<p>Then, he went on thinking, “I should now be more careful not to add fuel to the fire, otherwise, Lán Zhàn will be punished by copying the GūsūLán rules when he becomes sober.”</p>
		...
		<p>As he drove them back, Lán SīZhuī thought, “Both of them must have at one point suffered more than I could imagine. It must have been tough for them to attain a happy life they have now. So, I won’t let any misfortune happen to them again.”</p>
		...
		<p>He went on, “This Qīngxīn-líng is used by YúnmèngJiāng sect, and has the effect of calming people’s mind. Moreover, Wèi WúXiàn added into it a very powerful talisman that repels evil spirits.</p>
		...
		<p>Jīn Líng remarked, “No matter how powerful HánGuāng-Jūn is, he is still a human being. Also, unlike both of you who sometimes drink alcohol, his alcohol tolerance is worst than yours.</p>
...
export const ChapFour =
	<div>
		...
		<p>Lán SīZhuī went on, “Since I couldn’t wake you up, I played Melody of Lucidity. Then, when you got better, there was suddenly a smell of wine in the room. It felt like resentful energy. So, I played an aggressive tune, and the smell vanished.”</p>
		...
		<p>As the other two remained silent, Lán JǐngYí scratched his head, wondering if he had said something wrong.</p>
		<p>He went on, “I can hardly imagine HánGuāng-Jūn being afraid of something.”</p>
		<p>Jīn Líng frowned. He didn’t know what to say, and kept quiet.</p>
		<p>Lán SīZhuī wanted to say something but he hesitated. He then dropped his gaze and thought, “It’s not hard to imagine what HánGuāng-Jūn is afraid of.</p>
		...
		<p>He thought, “Young boys, it’s not that I want to corrupt your innocence or chastity. It’s just that I can’t handle Lán Zhàn when he is drunk. He is too strong for me, and once he set up his mind to do something, he won’t give in, no matter what.”</p>
		...
		<p>Wèi WúXiàn put a hand on his forehead and thought, “Oh my! How did it slip my mind that when Lán Zhàn is drunk, he turns a deaf ear to everything that he doesn’t want to hear?”</p>
		...
		<p>Wèi WúXiàn amusingly thought, “As time goes by, it’s getting harder to see this reaction when I tease Lán Èr-gōngzǐ*. But now that he is drunk not only he becomes frank and stubborn, but also he has this innocent expression of a teenager. This is quite interesting.”</p>
		...
		<p>And, each time it happened, Wèi WúXiàn was like seized by a feeling of a great accomplishment, he thought, “Lán Zhàn’s current state of arousal is caused by me.”</p>
...
export const ChapFive =
	<div>
		...
		<p>Lán WàngJī went on, “And, it’s been more that three years that what we feel for each other is mutual.”</p>
		<p>“Indeed,” said Wèi WúXiàn.</p>
		<p>Lán WàngJī said, “Uncle has even included us on the family record book as a couple.”</p>
		...
		<p>He then buried his face in Wèi WúXiàn’s neck, and, in a sad tone, he went on, “I remember everything, however, I couldn’t recall them straight away.”</p>
		...
		<p>Wèi WúXiàn went on, “However, my HánGuāng-Jūn is so amazing. You have quickly recovered your memories.”</p>
		...
		<p>“And now, he said with regret that he shouldn’t have let me by myself at that time.” thought Wèi WúXiàn.</p>
		<p>“Back then, when I was thrown into the mass grave, what kind of state of mind had you been in?” Wèi WúXiàn went on.</p>
		<p>“About what happened at Nightless Sky City, can you please not recall them at all?" he kept on thinking.</p>
		...
		<p>He went on, “And, since some common people over there have recovered, I also believe that HánGuāng-Jūn will wake up soon. So, don’t worry, SīZhuī.”</p>
		...
		<p>He went on. “Since the resentful energy that entered my body was expelled after I was frightened in my dream, what exactly does Wèi-qiánbèi need to do, in order to force the resentful energy out of HánGuāng-Jūn’s body?”</p>
		<br />
		<p>... ... ...</p>
		<br />
		...
		<p>“My mind is finally in peace,” Lán WàngJī thought, “I can now relax my whole body, because this is not a dream, the person in front me has indeed become my partner.”</p>
		<p>He went on, “He is no longer a spirit that I couldn’t contact, nor is he a yearning that I couldn’t obtain.”</p>
...
export const ChapSix =
	<div>
		...
		<p>“However,” he went on, “since I was really concerned about his condition, it didn’t cross my mind to even change clothes, let alone taking a bath.”</p>
		...
		<p>“If this is what you want, I’ll give you even more,” thought Wèi WúXiàn.</p>
		...
		<p>He then thought, “This should be his right hand. He uses these fingers to pluck at the strings of his guqin.”</p>
		...
		<p>Lán WàngJī gently kissed him on the forehead, then he smiled. He got into the bed and lay next to him. He whispered, “Wèi Yīng, I won’t leave you either. I will always stay by your side.”</p>
		<br />
		<p>... ... ...</p>
		<br />
		...
		<p>Jīn Líng was astonished. “Didn’t he ask me to meet him in Yúnmèng in two hours?” he thought, “His lack of patience is really getting worse.”</p>
...
export const ChapSeven =
	<div>
		...
		<p>All of a sudden, he was seized by an overwhelming emotion, and couldn't find his words. “Wèi WúXiàn, you’re really——,” he thought, “How someone can possibly describe you?”</p>
		...
		<p>Jīn Líng became suddenly alarmed and thought, “Why, out of nowhere, does he bring HánGuāng-Jūn into our conversation?”</p>
		...
		<p>“You couldn't even protect him, but you are worried about the commotion that will arise if other people find out?! I will see if you can stop me!” Jiang Cheng went on furiously.</p>
		...
		<p>Jīn Líng went on, “Can someone tell me who should I help if those two get into a fight?”</p>
		<p>Then, something crossed his mind, “Wait a minute! This is not good! Uncle, can you beat Wèi WúXiàn?!” Jīn Líng got worried.</p>
		...
		<p>He then thought, “Oh my, uncle, they have already become a couple, why do you want to meddle in their affairs?”</p>
		...
		<p>“I almost forget that I have this good stuff,” he thought. Then he quickly returned to his room, took out the talisman from his sleeve, and wrote a few words on it.</p>
		...
		<p>Once, Lán Yǎn saw Qīnghéng-Jūn, with a gentle gaze in his eyes, quietly looking towards Jingshi, the dwelling where his wife was living. Lán Yǎn sighed and thought, “He never regrets his decision.”</p>
...
export const ChapEight = 
	<div>
		...
		<p>Gritting his teeth, Lán SīZhuī thought, “Sometimes, Wèi-qiánbèi secretly works hard to solve issues that occur in Yúnmèng and Lánlíng territories.</p>
		...
		<p>Surprised, Wèi WúXiàn thought, “It’s Wēn Níng!”</p>
...
export const ChapNine =
	<div>
		<br />
		<p>As soon as the sound of his flute began to pierce through the air, countless of wronged souls and fierce corpses howled as they surged forward.</p>
		<p>Their roars filled the air, and wherever they attacked, they would left several dismembered corpses in a pool of blood. In a short time, the place turned into a river of blood.</p>
		<p>As he looked at the scene in front of him, Wèi WúXiàn suddenly felt exhausted, and said to himself, “Enough! I’m really tired.”</p>
		<p>“A-Xiàn!”</p>
		<p>At that precise moment, he heard a female voice, full of worry, calling his name. He was suddenly seized with fear, and his whole body began to shake uncontrollably. In the very next instant, he felt a frail body lying in his arms, covered with blood.</p>
		<p>“No! I don’t want this to happen!” he said to himself.</p>
		<p>A slender hand slowly touched his cheek. But Wèi WúXiàn was too scared to even cast a quick glance at her.</p>
		<p>“A-Xiàn. Xiàn-Xiàn.”</p>
		<p>“Shījiě.” Wèi WúXiàn uttered in response.</p>
		<p>He really wanted to see his Shījiě’s face once more, but he lacked the courage to do so. Suddenly, she was taken away by Jiāng Chéng.</p>
		<p>“Sis, it’s all right. It’s just a scratch from a sword.” Jiāng Chéng hurriedly assured Jiāng YànLí after checking her wound.</p>
		<p>At that time, Wèi WúXiàn’s mind was occupied with only one thought: running away from here. Anywhere would be fine, as long as wasn’t here. He wouldn’t bear to see her die for the second time because of him.</p>
		<p>He was no long in control of the battle around him. Paying no heed to what Jiāng Chéng was asking him, Wèi WúXiàn desperately crawled across the battlefield, then ran away from the bloody scene.</p>
		<p>“That’s it. This is how it should be. I don’t want to implicate anyone any more. If someone must die, then it would be only me.” Wèi WúXiàn thought while he was running as if he had devil at his heels.</p>
		<p>“Wèi Yīng!... Wèi Yīng!”</p>
		<p>The call brought Wèi WúXiàn to a standstill, and his eyes lit up. “Lán Zhàn?” he exclaimed, “Lán Zhàn is here!” Then he called out, “Lán Zhàn, where are you.”</p>
		<p>A glimmer of light suddenly appeared in the distance. Wèi WúXiàn looked carefully and noticed that the dim light was coming from a cave.</p>
		<p>“Lán Zhàn must be in there!” Wèi WúXiàn began to run desperately towards that source of light.</p>
		<p>Upon reaching the cave’s entrance, Wèi WúXiàn was extremely shocked by the scene he observed inside.</p>
		<p>Lán WàngJī’s white clothes were in tatters, revealing several deep and shallow sword wounds; and his hair, usually perfectly tidy, was dishevelled. However, he paid no heed to all of this. He was kneeling on one knee in front of another Wèi WúXiàn, who was sitting on the ground, covered in blood, and looking as pale as a ghost.</p>
		<p>Extremely anxious, Lán WàngJī was talking to his other self. This scene afflicted him more pain than that of his Shījiě; Wèi WúXiàn howled like an animal in distress; his knees failed him, causing him to slump to the ground.</p>
		<p>In agony, he watched how Lán WàngJī held the face of his other self and whispered to him words he had never heard before.</p>
		<p>“Wèi Yīng, can you hear me?”</p>
		<p>“Go away!”</p>
		<p>Lán Zhàn, don’t speak to him. He can’t hear you.</p>
		<p>“Wèi Yīng, I feel regretful for not being able to confess my feelings to you.”</p>
		<p>Please don’t speak.</p>
		<p>“Wèi Yīng, I’ve never hated you. Believe me.”</p>
		<p>I believe you. I really do.</p>
		<p>“You’ve always been incredibly smart and outspoken, which make you stand out from the crowd. And I like the rabbits you gave me. I’ve also kept your painting.”</p>
		<p>“I’ve always wanted to go with you to Yúnmèng, and do all those things you’ve told me. I know that you have your own reasons for acting the way you do. Can we work out together to find a solution?”</p>
		<p>Lán Zhàn, I beg you, no more talking</p>
		<p>“Wèi Yīng, no matter what the road ahead holds, I am willing to face it with you.”</p>
		<p>At this point, Wèi WúXiàn began to sob.</p>
		<p>“Wèi Yīng, I have feelings for you. Do you feel the same about me?”</p>
		<p>“Lán Zhàn!” Wèi WúXiàn could no longer suppress his pain and cried out loud, repeatedly calling Lán WàngJī.</p>
		<p>Suddenly, he felt two arms hugging him with tenderness. However, he kept on crying, and his tears dropped on Lán WàngJī’s thin garment.</p>
		<p>Earlier, upon hearing Wèi WúXiàn howling in his sleep, Lán WàngJī closed the door and walked quickly to check on him.</p>
		<p>He found Wèi WúXiàn having a nightmare—his slender body was curled up and shaking violently, while he was crying hard.</p>
		<p>Deeply concerned, Lán WàngJī carried him on his laps and cuddled him close.</p>
		<p>As Wèi WúXiàn continued to cry, Lán WàngJī held his face and tenderly kissed his eyelids, while gently stroking his back to soothe him.</p>
		<p>Wèi WúXiàn didn’t know whether he should feel sad for Lán WàngJī, or be angry at himself for having such a bad memory.</p>
		<p>Now that he had woken up, Wèi WúXiàn stared at Lán WàngJī with sadness—the same person, who was extremely worried about his other self in his dream, was now looked at him with concern.</p>
		<p>Lán WàngJī had rarely seen Wèi WúXiàn in such a hysterical state. Moreover, he was still drunk and at loss; he didn’t know what to say or do. He just kept on kissing his eyelids as though it would stop Wèi WúXiàn’s tears from rolling down.</p>
		<p>Lán XīChén’s hearing ability was very good, nothing had escape his perception. He clearly heard Wèi WúXiàn crying, and got worried. After a short moment of hesitation, he knocked on the door, and asked “WàngJī, is WúXiàn all right?”</p>
		<p>Wèi WúXiàn was startled when he heard Lán XīChén’s voice, he asked, “Lán Zhàn, why is Dà-gē here?”</p>
		<p>Lán WàngJī gently wiped the tears from the corners of Wèi WúXiàn’s eyes, then replied, “I don’t know.”</p>
		<p>Wèi WúXiàn was a little bit surprised by Lán WàngJī’s reply, then realised that since Lán XīChén had asked about him, therefore he must have heard him crying. He suddenly felt embarrassed.</p>
		<p>Then it crossed his mind that Lán XīChén might have something important to tell them, and since he was sleeping, it was probably inconvenient for him to come in.</p>
		<p>He sat up and tried get out of Lán WàngJī’s arms, but Lán WàngJī put him in bed, and pulled the duvet over him, he said, “You haven’t had enough sleep. Just keep resting.”</p>
		<p>Wèi WúXiàn was amused as well as helpless, he said, “Lán Zhàn, you shouldn’t let Dà-gē waiting outside.”</p>
		<p>“As an older brother, he should be tolerant and patient with me,” Lán WàngJī remarked.</p>
		<p>Meanwhile, outside the door, Lán XīChén, who was about to knock again, paused as he listened to what his young brother was saying.</p>
		<p>Wèi WúXiàn couldn’t believe his ears, thinking that Xiǎo-gǔbǎn* became really bold while he was drunk. His words could cause anyone to feel like stuck by lightning.</p>
		...
		<p>He then tugged gently at Lán WàngJī’s sleeve and, in a coaxing voice, said, “Lán Zhàn, you’re not being reasonable. Dà-gē must have something important to tell us. Let him in.”</p>
		<p>As Lán WàngJī didn’t say anything, only pursed his lips, Wèi WúXiàn thought that he agreed with him. However, when he was about to invite Lán XīChén in, all of a sudden, Lán WàngJī kissed him on the lips.</p>
		<p>He was usually the one who surprised Lán WàngJī with a sudden smooch, and being gazed at so closely after the kiss, Wèi WúXiàn felt his body flush with heat.</p>
		<p>As he looked at Wèi WúXiàn, Lán WàngJī’s eyes became lustful. He then curbed his desire, leaned his forehead on Wèi WúXiàn’s, and said, “Xiōng-zhǎng, right now, it’s not appropriate for you to come in.”</p>
		<p>As he noticed that Wèi WúXiàn was shocked by what he just said, with his head, Lán WàngJī gestured for him to look in the direction of the screen divider. And when he did, Wèi WúXiàn could not believe in his eyes how messy it was.</p>
		<p>If Lán XīChén came in and saw this mess, they would be too embarrassed to face him. Wèi WúXiàn quickly composed himself and said, “Sorry, Dà-gē, could you please wait a moment?”</p>
		<p>Lán XīChén replied, "No problem, I’ll wait." He then went and stood in the grassland opposite Jingshi.</p>
		<p>Not far away, many white rabbits huddled close and grazed on the grass, and since they were familiar with Lán XīChén, they were not afraid, even two of them came over to his feet.</p>
		<p>That brought a smile on his face. Lán XīChén picked one up and stroked it gently on the back.</p>
		<p>At that moment, the rustle of clothes coming from the room reached his ear. As a gentleman, he knew that he shouldn’t listen to whatever happened inside Jingshi. So, he moved farther away.</p>
		<p>Soon after, he saw the door open, and Lán WàngJī stepped out holding a pile of clothes, gently closed the door behind him using his foot, and headed towards the laundry.</p>
		<p>An instant later, he saw him return into the room, and realised the extent to which his young brother doted on his partner. He chuckled while gently shaking his head.</p>
		<p>As he was about to put the rabbit down, Lán XīChén sensed a strong spiritual pressure approaching.</p>
		<p>Drawing close to Jingshi, Jiāng Chéng noticed ‘Lán WàngJī’ dressed in white standing in the grassland with a large group of the rabbits.</p>
		<p>“Does Lán WàngJī raise rabbits?” Jiāng Chéng couldn’t help but twitch the corner of his mouth at that thought.</p>
		<p>He then realised that it was Lán XīChén, since the two brothers looked similar in appearance, but differed in their personality.</p>
		<p>Lán XīChén looked surprised to see Jiāng Chéng, but showed no sign of wariness or hostility.</p>
		<p>Jiāng Chéng knew that he had trespassed on Yúnshēn Bùzhīchù, but he was determined to find what happened to Wèi WúXiàn.</p>
		<p>As he came closer to Lán XīChén, he said, “Zéwú-Jūn, I have an important matter to discuss with Wèi WúXiàn, and I hope you will forgive my intrusion.”</p>
		<p>Lán XīChén put the rabbit down, smiled and replied, “Jiāng Zōng-zhǔ, there’s no need to apologise. You actually arrived at the perfect timing.”</p>
		<p>Since Lán XīChén wanted to discuss the issue that had occurred in Yúnmèng, Jiāng Chéng’s presence was indispensable. He also thought that having a face-to-face talk instead of helping each other secretly would improve the relationship between Wèi WúXiàn and Jiāng Chéng.</p>
		<p>Lán XīChén’s words surprised Jiāng Chéng, since he was thinking that GūsūLán didn’t want the news of Wèi WúXiàn being injured to get spread. At the same time, he felt relieved, and asked, “Zéwú-Jūn, what do you mean by that?”</p>
		<p>As Lán XīChén was about to reply, the door of Jingshi opened again, and the first thing that came into view was a large wooden bathtub slightly damaged. Both, Jiāng Chéng and Lán XīChén, were speechless.</p>
	</div>

export const ChapTen =
	<div>
		<br />
		<p>Since the bathtub was deformed and water was still in it, it was awkward for Lán WàngJī to carry it. So, from where they were, Lán XīChén and Jiāng Chéng saw a moving bathtub, which was a strange sight, until Lán WàngJī turned around to close the door and walked away.</p>
		<p>In astonishment, Jiāng Chéng stared at Lán WàngJī, who usually looked elegant and dignified, holding a bathtub that was comically oversized, causing him to forget temporary why he was there in the first place.</p>
		<p>As he noticed the shocking expression on Jiāng Chéng’s face, Lán XīChén said, “Jiāng Zōng-zhǔ, please forgive this sorry sight. WàngJī is still intoxicated and not behaving as he normally would.”</p>
		<p>Jiāng Chéng looked puzzled. How could Lán WàngJī get drunk when GūsūLán’s rules prohibited drinking alcohol.</p>
		<p>Lán XīChén then explained, “WàngJī has been affected by the smell of wine while they were out on their Night Hunting.”</p>
		<p>Surprised, Jiāng Chéng exclaimed, “HánGuāng-Jūn is drunk because the smell of alcohol! What about Wèi WúXiàn? Is he all right?”</p>
		<p>“Of course, I’m fine.”</p>
		<p>Wèi WúXiàn was standing in the doorway, rubbing his lower back, then walked forward with somewhat unsteady steps.</p>
		<p>Jiāng Chéng observed him for a while, and suddenly, he frowned angrily, without uttering a single word.</p>
		<p>As he noticed the change in Jiāng Chéng’s mood, Wèi WúXiàn immediately came to a halt.</p>
		<p>He was already aware of the two them standing outside, but Lán WàngJī didn’t want him to come out because his whole body was aching. However, when he heard Jiāng Chéng asking about him with concern, he hurriedly put on his outer robe and opened the door.</p>
		<p>Wèi WúXiàn thought, “Just now, his facial expression was fine, why does he suddenly seem angry? Did Jīn Líng say something about me that got him upset?”</p>
		<p>Jiāng Chéng had all the reason to get angry. After learning that Wèi WúXiàn was ‘injured’, he rushed over here. He even threatened a GūsūLán disciple.</p>
		<p>When he finally saw Wèi WúXiàn, Jiāng Chéng noted that he had a dishevelled appearance: his eyes were red; he seemed to be drained of all his strength; and his neck was covered in love bites to the point that it became awkward to look at him.</p>
		<p>In an irritable mood, Jiāng Chéng thought, “Do I have nothing better to do than listening to Jīn Líng’s nonsense?”</p>
		<p>At Jīnlíntái, a young boy snooze twice* loudly.</p>
		<small>*In Chinese culture, sneezing once means: someone is missing you, twice: someone is cursing you, and three times: someone is in love with you.</small>
		<p>Lán XīChén thought about leaving but couldn’t, because Jiāng Chéng’s mood had changed drastically.</p>
		<p>At that moment, Lán WàngJī, who had returned, walked quietly forward and stood in front of Wèi WúXiàn, blocking Jiāng Chéng’s view of him.</p>
		<p>It was easy to see that Lán WàngJī did it on purpose, which caused Jiāng Chéng to fume. He slowly uttered, “Lán WàngJī!”</p>
		<p>In a very cold tone, Lán WàngJī retorted, “Jiāng WǎnYín*!”</p>
		<small>*Jiāng WǎnYín is Jiāng Chéng’s given name (rarely mentioned).</small>
		<p>The air between them thickened under the weight of their spiritual energies, which pressed against each other in open conflict. Now and then, tiny sparks of lightning crackled where the powers collided.</p>
		<p>Lán XīChén thought that this situation was not optimistic.</p>
		<p>Wèi WúXiàn gently tugged at Lán WàngJī’s sleeve, wanting to coax him to calm down.</p>
		<p>Lán SīZhuī and Lán JǐngYí, who just arrived, were shocked by the scene, as well as surprised to see that Lán XīChén was there too.</p>
		<p>After they saluted Lán XīChén, Lán JǐngYí said angrily, “Jiāng Zōng-zhǔ, Wèi-qiánbèi has never provoked or offended you in any way. Since Zéwú-Jūn is here as well, why don’t you all have a good talk together instead?”</p>
		<p>“JǐngYí!” Lán SīZhuī scolded him, then observed that the situation seemed not to be like he had initially thought.</p>
		<p>Wèi WúXiàn was confused by Lán JǐngYí’s words, wondering what Jiāng Chéng wanted to say to him. However, as he sensed Lán WàngJī’s spiritual pressure became more intense, Wèi WúXiàn quickly brought his attention back to him, he said, “Lán Zhàn, Jiāng Chéng has no ill intentions.”</p>
		<p>But Lán WàngJī didn’t respond. So Wèi WúXiàn tried again this time by holding his hand and gently shook it.</p>
		<p>Finally, Lán WàngJī restrained his spiritual pressure, turned around and looked at Wèi WúXiàn with tenderness.</p>
		<p>Jiāng Chéng hated it when these two displayed their affection in his presence. Just as he was about to say something, he saw Lán WàngJī hug Wèi WúXiàn and kiss him in front of everyone.</p>
		<p>The kissing scene caused a shock to everyone. Lán SīZhuī and Lán JǐngYí’s faces flushed instantly, they hurriedly lowered their heads, daring not to look at the two lovers.</p>
		<p>Wèi WúXiàn lost count of how many times Lán WàngJī caught him off guard.</p>
		<p>Three years ago, at Lotus Piers, Jiāng Chéng had seen him hug Lán WàngJī under the tree. Since then, Wèi WúXiàn had been careful, taking Lán WàngJī’s reputation into consideration.</p>
		<p>However, in just one day, all his efforts were ruined because of Lán WàngJī being drunk. Moreover, it happened in front of Jiāng Chéng once again.</p>
		<p>Wèi WúXiàn’s cheeks took on a pink tint. His hand pressed to his forehead, Wèi WúXiàn was certain that Lán WàngJī had done it on purpose, convinced that he shouldn’t be let out while he was drunk.</p>
		<p>“I have to say something, otherwise a fight between them will break out,” thought Wèi WúXiàn.</p>
		<p>Trying hard to ignore the eyes on him, especially Jiāng Chéng’s glare, Wèi WúXiàn swallowed hard, met Lán WàngJī’s gaze, and began, “Lán Zhàn, I think——”</p>
		<p>“Don’t say it!” Lán WàngJī interrupted him.</p>
		<p>“Ah?” Wèi WúXiàn got puzzled.</p>
		<p>Still holding Wèi WúXiàn in his arms, unwilling to let him go,  Lán WàngJī said angrily, “Don’t say his name.”</p>
		<p>It was clear to everyone that  Lán WàngJī was referring to Jiāng Chéng. And Wèi WúXiàn felt helpless as he noticed a flash of purple light.</p>
		<p>Lán WàngJī’s words got Jiāng Chéng very upset that he could no longer restrain himself.</p>
		<p>Back then, when they were teenagers, although Jiāng Chéng admired Lán WàngJī, he didn’t think that they would interact each other in the future.</p>
		<p>Likewise, he never imagined that a day would come when Wèi WúXiàn would leave Lotus Piers, where he was raised, become Lán WàngJī’s partner, and live in Yúnshēn Bùzhīchù, a place he once despised because of their strict rules.</p>
		<p>After everything was settled down, Jiāng Chéng never expected he would rashly break into Yúnshēn Bùzhīchù for Wèi WúXiàn’s sake, and want to fight with Lán WàngJī.</p>
		<p>As he sensed Jiāng Chéng’s fighting aura, Lán WàngJī let go of Wèi WúXiàn and, while turning around, made sure that Wèi WúXiàn stayed behind him, then he summoned Bìchén.</p>
		<p>The spiritual energy of the sword flowed through its body, the edges shone brightly, and a faint sound of a dragon’s roar was emitted.</p>
		<p>Lán WàngJī stood tall and majestic, his white clothes began to flutter as though it was caused by the strong wind, and his spiritual energy became overwhelming.</p>
		<p>As this point, Lán XīChén could no longer stand by and watch. He hurried forward and said, “Jiāng Zōng-zhǔ, please don’t mind WàngJī’s words when he is under the influence of alcohol. Furthermore, here is Yúnshēn Bùzhīchù, so think twice.”</p>
		<p>Jiāng Chéng sneered, “Zéwú-Jūn, since I’ve dared to trespass on your property, I no longer care about the consequences.”</p>
		<p>Lán WàngJī stepped forward and said, “Xiōng-zhǎng, there’s no need to talk to him.”</p>
		<p>Then he slowly turned his head and glared at Jiāng Chéng, he said coldly, “There must be a fight between you and me.”</p>
		<p>With anxiety, Wèi WúXiàn said, “Lán Zhàn, wait!”</p>
		<p>However, the two of them had already reached the point of no return. They launched their attacks simultaneously, and Zǐdiàn and Bìchén collided violently, producing the deafening sound of an explosion.</p>
		<p>The impact of their spiritual energies distorted the surrounding air, creating waves that swept the area with an overwhelming pressure.</p>
		<p>Standing nearby, Lán SīZhuī and Lán JǐngYí couldn’t dodge on time and, since their cultivation levels were not as strong as theirs, they were instantly affected: their ears were ringing and their hearts were pumping fast.</p>
		<p>Lán SīZhuī tried hard to hold back the blood that was about to come out of his mouth. Out of the corner of his eye, he saw Wèi WúXiàn stagger backwards onto his feet, which alarmed him. He then rushed over and held Wèi WúXiàn by the arm, he asked, “Wèi-qiánbèi, are you all right?”</p>
		<p>In normal circumstances, Wèi WúXiàn wouldn’t be thrown off balance by the aftermath. He was extremely exhausted due to their intense activity in the bathtub and, later on, because of his nightmare, he didn’t sleep much. Therefore, he hadn’t recovered all his strength.</p>
		<p>Wèi WúXiàn patted Lán SīZhuī’s hand, signalling him that he was fine. Then, by observing the two men venting their anger and frustration, he predicted the outcome the fight.</p>
		<p>Lán WàngJī had always harboured a grudge against Jiāng Chéng. If he were not drunk and for Jīn Líng’s sake, he would restrain himself.</p>
		<p>However, right now, it wasn’t the case. Lán WàngJī gave free rein to his emotions and didn’t hold back on his attacks, which were incredibly powerful. </p>
		<p>On the other hand, Jiāng Chéng’s bark was worse than his bite. He was a soft-hearted person and didn’t use any ruthless moves. It was only a matter of time before he got defeated.</p>
		<p>While he was fighting Lán WàngJī, from time to time, Jiāng Chéng couldn’t help but look in the direction of Wèi WúXiàn to check on his condition.</p>
		<p>Lán XīChén looked at Wèi WúXiàn in his eyes and nodded.</p>
		<p>Wèi WúXiàn immediately understood Lán XīChén’s intention and, patting Lán SīZhuī’s shoulder, he said, “SīZhuī, take JǐngYí and go far from here. Make sure that no one comes this way.”</p>
		<p>Lán SīZhuī worriedly said, “But Jiāng Zōng-zhǔ and HánGuāng-Jūn are fighting.”</p>
		<p>As pulled off Chénqíng from his waist-band, Wèi WúXiàn replied with smile, “Don’t worry. Even though HánGuāng-Jūn is drunk, he will never hurt me. Besides, Zéwú-Jūn is also here. So, hurry up. If uncle happens to know about this, we will be in trouble.”</p>
		<p>Indeed, if Lán Lǎo found out, the consequences would be unimaginable. Without further delay, Lán SīZhuī did as he was told.</p>
		<p>Choosing the right timing, Wèi WúXiàn rushed and stood between Lán WàngJī and Jiāng Chéng.</p>
		<p>As soon as Wèi WúXiàn appeared in front of each of them, they at once retracted their attacks. However, their spiritual energies couldn’t be stopped.</p>
		<p>Lán XīChén drew Shuòyuè and neutralised Jiāng Chéng’s purple lightning. Wèi WúXiàn used Chénqíng to block Lán WàngJī’s spiritual pressure, but since he was in poor condition, he stumbled backwards before steadying himself.</p>
		<p>Lán WàngJī was startled. He hurried over and held Wèi WúXiàn in his arms. As he was about to transfer his spiritual energy to him through the wrist, he saw Wèi WúXiàn smile at him and stop him from doing so.</p>
		<p>Jiāng Chéng was already alarmed when he saw Wèi WúXiàn stagger backwards. However, his emotions became even worse when he saw Lán WàngJī ready to channel his spiritual energy to Wèi WúXiàn. He felt like being struck by lightning, as something had suddenly crossed his mind.</p>
	</div>
